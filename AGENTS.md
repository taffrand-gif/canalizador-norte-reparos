...
- Dépôt : `canalizador-norte-reparos`
- Domaine : `canalizador-norte-reparos.pt`
- Métier : plomberie
- Langue client : PT-PT

## Règles locales

Ne publier aucun claim DGEG, TRIESP, Ficha, Termo ou wallbox sur CNR. Ne pas inventer d’avis, de chantiers, de clients, de délais garantis ou de prix.
