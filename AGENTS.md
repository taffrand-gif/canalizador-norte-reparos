...
2. **Lire `SEO_PLAN.md` EN ENTIER** (tâches B1-B3 = différenciation homepage + schema FAQPage)
3. **Consigner toute action** dans la section `🔄 HISTORIQUE` du `SEO_PLAN.md`
4. **Suivre l'ordre strict** : B1 (homepage) → B2 (FAQPage) → B3 (H1 sémantique) → C (backlinks)
