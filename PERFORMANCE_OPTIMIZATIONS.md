# Optimisations de Performance - Norte Reparos

## Résumé des Modifications

Ce document détaille les optimisations de performance appliquées au site norte-reparos.
...
**Fichier modifié:** `/private/tmp/norte-reparos/vite.config.ts`
...
**Fichier modifié:** `/private/tmp/norte-reparos/client/index.html`
...
<link rel="preload" as="image"
      href="/images-optimized/hero/hero-plumber-portugal.jpg"
      fetchpriority="high" />
...
**Fichier modifié:** `/private/tmp/norte-reparos/server/index.ts`
