...
export default function NotFound() {
 ...
 <>
 <Helmet>
 <title>Página Não Encontrada | Norte Reparos - Canalizador</title>
 ...
 <link rel="canonical" href="https://canalizador-norte-reparos.pt/404" />
 </Helmet>
 ...
 className="inline-flex items-center justify-center bg-[#2193b0] hover:bg-[#197a92] text-white px-6 py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
 >
