...
export default function Zonas() {
 ...
 useEffect(() => {
 document.title = 'Zona de Intervenção - Canalizador em Trás-os-Montes | 34 Cidades Servidas';
 ...
 'content',
 'Canalizador profissional em 34 cidades de Trás-os-Montes. Raio de 130 km desde a nossa base. Orçamento por escrito em 48h. Bragança, Vila Real, Chaves, Mirandela e toda a região.'
 );
 ...
 '@type': 'Service',
 name: 'Canalizador Profissional em Trás-os-Montes',
 provider: {
 '@type': 'LocalBusiness',
 name: 'Norte Reparos',
 ...
 <a
 href={`/canalizador-${city.slug}`}
 className="block p-4 bg-white rounded-lg border border-gray-200 hover:border-[#2193b0] hover:shadow-md transition-all duration-200"
 >
 ...
 <div className="text-[#0e7490] text-sm font-medium">Ver página →</div>
 </div>
 </a>
 );
 return (
 ...
 {/* Hero Section */}
 <section className="bg-gradient-to-br from-[#2193b0] to-[#1a7a8f] text-white py-16">
 ...
 <MapPin className="w-8 h-8 mr-3 text-[#0e7490]" />
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-4">Precisa de um Canalizador?</h2>
 ...
 className="inline-flex items-center justify-center px-8 py-4 bg-green-700 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors"
 >
 WhatsApp
 </a>
 </div>
