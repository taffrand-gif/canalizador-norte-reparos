...
export default function CanoRebentado() {
 useEffect(() => {
 document.title = "Cano Rebentado? Paramos a Inundação Atendimento | Norte Reparos";
 ...
 meta.setAttribute('content', 'Cano rebentado? Inundação em casa? Paramos a água Atendimento. Atendimento 24h/7d. Arranjo urgente. Ligue +351 928 484 451.');
 }, []);
 const faqSchema = {
