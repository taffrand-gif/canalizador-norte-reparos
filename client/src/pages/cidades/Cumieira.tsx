// SEO optimizada para "Canalizador Cumieira"
...
export default function Cumieira() {
  const faqs = [
    {
    ...
    },
    {
      ...
      answer: "Sim, atendemos urgências de fugas de água e desentupimentos 24h por dia, 7 dias por semana em Cumieira e toda a zona de Santa Marta de Penaguião. Ligue 928 484 451 para atendimento."
    },
    {
      question: "Fazem desentupimentos em Cumieira?",
      answer: "Sim, fazemos desentupimentos de esgotos, lavatórios, sanitas e ralos em Cumieira. Somos especialistas em habitações rurais e quintas com fossas sépticas e sistemas de captação de água de nascente. Orçamento gratuito antes de qualquer trabalho."
    },
    {
    ...
    },
    {
      ...
      answer: "Cobrimos Cumieira e toda a área: Cumieira, Santa Marta de Penaguião, Lobrigos, Medrões, Fornelos. Disponíveis 24h incluindo fins de semana e feriados."
    }
  ];
  ...
  useEffect(() => {
    ...
    mk.setAttribute('content', 'canalizador cumieira, canalizador urgente cumieira, desentupimento cumieira, fuga agua santa marta, canalizador vila real, canalizador tras-os-montes');

    let can = document.querySelector('link[rel="canonical"]');
    if (!can) { can = document.createElement('link'); can.setAttribute('rel', 'canonical'); document.head.appendChild(can); }
    can.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-cumieira');

    const s = document.createElement('script');
    s.type = 'application/ld+json'; s.id = 'schema-cumieira';
    ...
    return () => {
      const s1 = document.getElementById('schema-cumieira'); if (s1) document.head.removeChild(s1);
      const s2 = document.querySelector('script[data-faq-schema]'); if (s2) document.head.removeChild(s2);
    };
  }, []);

  const cidadesProximas = getCidadesProximas('cumieira');
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
        <section className="bg-gradient-to-r from-gray-900 to-blue-800 text-white py-16">
          <div className="container mx-auto px-4"><div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href={`https://wa.me/${businessInfo.whatsapp}?text=Olá, preciso de um canalizador em Cumieira`} target="_blank" rel="noopener noreferrer" className="bg-blue-500 hover:bg-blue-400 text-white font-bold px-8 py-4 rounded-lg text-lg transition-colors text-center">💬 WhatsApp</a>
            </div>
          </div></div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">Cobrimos Cumieira e toda a área de Santa Marta de Penaguião. Deslocação 55€ (Zona 5). Mão de obra 65€/h. Orçamento gratuito.</p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-blue-100">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                ...
                <div key="Lobrigos" className="flex items-center gap-2 text-gray-700 text-sm"><span className="text-blue-500">🔧</span><span>Lobrigos</span></div>
                <div key="Medrões" className="flex items-center gap-2 text-gray-700 text-sm"><span className="text-blue-500">🔧</span><span>Medrões</span></div>
                <div key="Fornelos" className="flex items-center gap-2 text-gray-700 text-sm"><span className="text-blue-500">🔧</span><span>Fornelos</span></div>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Perguntas sobre <span className="text-blue-600">Canalizador em Cumieira</span></h2>
        ...
        <CidadesProximas currentCity="Cumieira" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Cumieira" currentCitySlug="canalizador-cumieira" />
      </main>
      <Footer />
    </>
  );
