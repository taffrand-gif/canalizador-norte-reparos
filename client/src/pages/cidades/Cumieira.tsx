...
export default function Cumieira() {
  ...
  useEffect(() => {
    ...
    mk.setAttribute('content', 'canalizador cumieira, canalizador 24h cumieira, desentupimento cumieira, fuga agua santa marta, canalizador vila real, canalizador tras-os-montes');
