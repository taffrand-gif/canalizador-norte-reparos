...
export default function MacedoCavaleiros() {
  ...
  const faqs = [
    ...
    { question: "Fazem urgências em Macedo de Cavaleiros?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Macedo de Cavaleiros. Ligue +351 928 484 451." },
