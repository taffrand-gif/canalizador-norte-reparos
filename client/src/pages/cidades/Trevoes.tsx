// SEO optimizada para "Canalizador Trêvões"
...
export default function Trevoes() {
  const faqs = [
    {
    ...
    },
    {
      ...
      answer: "Sim, atendemos urgências de fugas de água e desentupimentos 24h por dia, 7 dias por semana em Trêvões e toda a zona de São João da Pesqueira. Ligue 928 484 451 para atendimento imediato."
    },
    {
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', 'canalizador trêvões, canalização trêvões, desentupimento trêvões, fuga de água trêvões, urgência 24h trêvões');
    ...
    schemaScript.text = JSON.stringify({
      ...
      "@type": "LocalBusiness",
      "name": "Norte Reparos — Canalizador Trêvões",
      "description": "Canalizador profissional em Trêvões. Desentupimentos, fugas de água, instalações sanitárias. Urgências 24h.",
      "telephone": businessInfo.phone,
      "priceRange": "€€",
      "areaServed": "Trêvões, São João da Pesqueira",
  ...
  const cidadesProximas = getCidadesProximas('Trêvões');
      ...
      <main className="min-h-screen bg-white">
        <div className="bg-blue-700 text-white py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <Breadcrumbs items={[
              ...
              { label: 'Canalizador Trêvões' }
            ]} />
            <h1 className="text-3xl font-bold mt-4 mb-2">Canalizador Trêvões</h1>
            <p className="text-blue-100 text-lg">Desentupimentos, fugas de água e instalações sanitárias em Trêvões. Urgências 24h, 7 dias por semana.</p>
        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          <section className="bg-blue-50 rounded-xl p-6 mb-10">
            <h2 className="text-xl font-bold text-blue-900 mb-3">Preços em Trêvões</h2>
