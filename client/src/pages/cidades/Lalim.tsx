...
export default function Lalim() {
  ...
  const faqs = [
    ...
    { question: "Fazem urgências em Lalim?", answer: "Sim, Atendimento 24h/7d, 7 dias por semana em Lalim. Ligue +351 928 484 451." },
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Disponível 24h/7 dias em Lalim. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
