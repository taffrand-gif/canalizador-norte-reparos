// SEO optimizada para "Canalizador Vilarandelo"
...
export default function Vilarandelo() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "Canalizador Vilarandelo 💧 24h | 928 484 451";
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Vilarandelo. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-vilarandelo');

    const cityAddress = getCityAddress('vilarandelo');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-vilarandelo';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — Vilarandelo",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.5500", "longitude": "-7.4167" },
  ...
  const cidadesProximas = getCidadesProximas('vilarandelo');

  const faqs = [
    { question: "Qual o preço de canalizador em Vilarandelo?", answer: "Desde 110€ em Vilarandelo. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
    { question: "Fazem urgências em Vilarandelo?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Vilarandelo. Ligue +351 928 484 451." },
  ...
  return (
    <>
      <SEOHeadEnhanced citySlug="vilarandelo" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'Vilarandelo', href: '/canalizador-vilarandelo' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">Vilarandelo</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador Vilarandelo: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Vilarandelo`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Vilarandelo — Terra da Oliveira e do Azeite
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Vila transmontana conhecida pela olivicultura e produção de azeite. A tradição oleira mantém-se viva na região.
              </p>
              <p className="text-gray-700">
                Zona fértil junto ao Rio Túa. A economia assenta na agricultura de sequeiro e na pecuária.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Vilarandelo
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em Vilarandelo</h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em Vilarandelo. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Vilarandelo</h2>
            <FAQSection faqs={faqs} />
          </div>
        </section>

        <CidadesProximas currentCity="Vilarandelo" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Vilarandelo" currentCitySlug="canalizador-vilarandelo" />
      </main>
      <Footer />
    </>
  );
