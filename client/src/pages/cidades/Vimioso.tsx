...
export default function Vimioso() {
 ...
 metaDescription.setAttribute('content', 'Canalizador urgente em Vimioso. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
 ...
 "geo": { "@type": "GeoCoordinates", "latitude": "41.6167", "longitude": "-6.4833" },
 ...
 return (
 <>
 <SEOHeadEnhanced citySlug="vimioso" pageType="city" />
 <StructuredData />
 <Header />
...
<p data-p1="answer-first" style={{ background: "#fff5e0", borderLeft: "4px solid #FF6B35",
  ...
  Em Vimioso, a deslocação é 45€ (Zona 4, 64 km de Macedo de Cavaleiros). Mão de obra 65 €/h, orçamento por escrito antes de qualquer trabalho. Contacto: <a href="tel:+351928484451" style={{ color: "#FF6B35", fontWeight: "bold", textDecoration: "none" }}>928 484 451</a>.
</p>
 ...
 Canalizador Profissional em <span className="text-orange-400">Vimioso</span>
 </h1>
 <p className="text-xl mb-8">
 Serviços de canalização certificados em Vimioso e arredores.
 ...
 📞 Canalizador Vimioso: {config.phone}
 </a>
 <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Vimioso`}
 ...
 Vimioso — Terra das Aldeias de Pedra
 </h2>
 <div className="max-w-4xl mx-auto">
 <p className="text-gray-700 mb-4">
 Concelho do planalto transmontano com aldeias de xisto bem preservadas. Paisagens de grande beleza natural.
 </p>
 <p className="text-gray-700">
 Zona de montanha com tradição na pastorícia e na produção de fumeiro. As aldeias têm sistemas de água partilhados.
 </p>
 </div>
 </div>
 </section>
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Serviços de Canalização em Vimioso
 </h2>
 ...
 <div className="container mx-auto px-4">
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em Vimioso</h2>
 ...
 <p className="text-gray-600">Disponível 24h/7 dias em Vimioso. Atendimento 24h para urgências.</p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
 ...
 <h2 className="text-3xl font-bold mb-6">Canalizador em <span className="text-orange-300">Vimioso</span></h2>
 ...
 <CidadesProximas currentCity="Vimioso" cidades={cidadesProximas} serviceType="canalizador" />
