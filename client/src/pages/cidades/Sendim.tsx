...
export default function Sendim() {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Sendim. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    const cityAddress = getCityAddress('sendim');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-sendim';
    schemaScript.text = JSON.stringify({
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.4500", "longitude": "-6.5667" },
  ...
  const faqs = [
    { question: "Qual o preço de canalizador em Sendim?", answer: "Desde 110€ em Sendim. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
    { question: "Fazem urgências em Sendim?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Sendim. Ligue +351 928 484 451." },
  ...
  return (
    <>
      <SEOHeadEnhanced citySlug="sendim" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">Sendim</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em Sendim e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador Sendim: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Sendim`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Sendim — Terra da Fronteira e do Fumeiro
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Povoação transmontana na fronteira com Espanha. Conhecida pela produção de fumeiro e pelos embutidos de porco preto.
              </p>
              <p className="text-gray-700">
                Zona de transição com forte tradição agrícola e pecuária. A proximidade com Espanha dinamiza o comércio local.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Sendim
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em Sendim</h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em Sendim. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Canalizador em <span className="text-orange-300">Sendim</span></h2>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Sendim</h2>
