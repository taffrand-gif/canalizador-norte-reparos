...
export default function VilaNovaFozCôa() {
  ...
  const faqs = [{'question': 'Qual o preço de canalizador em Vila Nova de Foz Côa?', 'answer': 'Desde 110€ em Vila Nova de Foz Côa. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Vila Nova de Foz Côa?', 'answer': 'Sim, atendimento 24 horas, 7 dias por semana em Vila Nova de Foz Côa. Ligue +351 928 484 451.'}, {'question': 'Atendem propriedades rurais em Vila Nova de Foz Côa?', 'answer': 'Sim, servimos todo o conselho incluindo propriedades rurais e aldeias isoladas.'}, {'question': 'Têm câmara termográfica para deteção de fugas?', 'answer': 'Sim, utilizamos câmara termográfica FLIR e geofone para localização precisa de fugas sem demolição.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];
