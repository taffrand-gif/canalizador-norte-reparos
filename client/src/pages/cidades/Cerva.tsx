// SEO optimizada para "Canalizador Cerva"
...
export default function Cerva() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Sim, atendemos urgências de fugas de água e desentupimentos 24h por dia, 7 dias por semana em Cerva e toda a zona de Ribeira de Pena. Ligue 928 484 451 para atendimento imediato."
    },
    {
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', 'canalizador cerva, canalização cerva, desentupimento cerva, fuga de água cerva, urgência 24h cerva');
    if (!metaKeywords.parentNode) document.head.appendChild(metaKeywords);

    const canonical = document.querySelector('link[rel="canonical"]') || document.createElement('link');
    canonical.setAttribute('rel', 'canonical');
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-cerva');
    ...
    schemaScript.text = JSON.stringify({
      ...
      "@type": "LocalBusiness",
      "name": "Norte Reparos — Canalizador Cerva",
      "description": "Canalizador profissional em Cerva. Desentupimentos, fugas de água, instalações sanitárias. Urgências 24h.",
      "telephone": businessInfo.phone,
      "priceRange": "€€",
      "areaServed": "Cerva, Ribeira de Pena",
  ...
  const cidadesProximas = getCidadesProximas('Cerva');
      ...
      <main className="min-h-screen bg-white">
        <div className="bg-blue-700 text-white py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <Breadcrumbs items={[
              ...
              { label: 'Canalizador Cerva' }
            ]} />
            <h1 className="text-3xl font-bold mt-4 mb-2">Canalizador Cerva</h1>
            <p className="text-blue-100 text-lg">Desentupimentos, fugas de água e instalações sanitárias em Cerva. Urgências 24h, 7 dias por semana.</p>
        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          <section className="bg-blue-50 rounded-xl p-6 mb-10">
            <h2 className="text-xl font-bold text-blue-900 mb-3">Preços em Cerva</h2>
