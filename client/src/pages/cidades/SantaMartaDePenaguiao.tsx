...
export default function SantaMartaPenaguião() {
  ...
  const faqs = [
    ...
    { question: "Fazem urgências em Santa Marta de Penaguião?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Santa Marta de Penaguião. Ligue +351 928 484 451." },
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em Santa Marta de Penaguião. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
