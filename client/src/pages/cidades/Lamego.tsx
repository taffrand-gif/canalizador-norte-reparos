...
export default function Lamego() {
 ...
 useEffect(() => {
 document.title = "Canalizador Lamego 💧 24h | 928 484 451";
 ...
 metaDescription.setAttribute('content', 'Canalizador urgente em Lamego. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
 ...
 canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-lamego');

 const cityAddress = getCityAddress('lamego');
 ...
 "geo": { "@type": "GeoCoordinates", "latitude": "41.0833", "longitude": "-7.8000" },
 ...
 const faqs = [{'question': 'Qual o preço de canalizador em Lamego?', 'answer': 'Desde 100€ (150 € noite/fim de semana) em Lamego. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Lamego?', 'answer': 'Sim, Atendimento 24h/7d, 7 dias por semana em Lamego. Ligue +351 928 484 451.'}, {'question': 'Atendem a zona do Douro Superior?', 'answer': 'Sim, servimos toda a região incluindo quintas vinícolas e propriedades rurais.'}, {'question': 'Que equipamento usam?', 'answer': 'Ridgid K9-102 para desentupimentos, câmara termográfica FLIR para deteção de fugas, geofone para tubagens enterradas.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];

 return (
 <>
 <SEOHeadEnhanced citySlug="lamego" pageType="city" />
 <StructuredData />
 <Header />
...
<p data-p1="answer-first" style={{ background: "#fff5e0", borderLeft: "4px solid #FF6B35",
  ...
  Em Lamego, a deslocação é 30€ (110.7 km de Macedo de Cavaleiros). Mão de obra 70 €/h, orçamento por escrito antes de qualquer trabalho. Contacto: <a href="tel:+351928484451" style={{ color: "#FF6B35", fontWeight: "bold", textDecoration: "none" }}>928 484 451</a>.
</p>
 ...
 { label: 'Lamego', href: '/canalizador-lamego' }
 ]} />
 <h1 className="text-4xl md:text-5xl font-bold mb-6">
 Canalizador Profissional em <span className="text-orange-400">Lamego</span>
 </h1>
 <p className="text-xl mb-8">
 Serviços de canalização certificados em Lamego e arredores.
 ...
 📞 Canalizador Lamego: {config.phone}
 </a>
 <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Lamego`}
 ...
 Lamego — Terra do Santuário e do Vinho do Porto
 </h2>
 <div className="max-w-4xl mx-auto">
 <p className="text-gray-700 mb-4">
 Cidade histórica com o Santuário de Nossa Senhora dos Remédios, um dos mais importantes do país. Região vinhateira do Douro.
 </p>
 <p className="text-gray-700">
 Capital da região do Douro Superior. O turismo religioso e o enoturismo são pilares da economia local.
 </p>
 </div>
 </div>
 </section>
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Serviços de Canalização em Lamego
 </h2>
 ...
 <p className="text-gray-600">
 Disponível 24h/7 dias em Lamego. Atendimento 24h para urgências.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
 <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
 ...
 Perguntas sobre <span className="text-blue-600">Canalizador em Lamego</span>
 </h2>
 <div className="max-w-3xl mx-auto space-y-6">
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Fazem intervenções em propriedades rurais de Lamego?
 </h3>
 <p className="text-gray-600">
 Sim, temos vasta experiência em propriedades rurais, quintas e explorações
 agrícolas de Lamego. Os nossos veículos têm equipamento completo
 para intervenções em qualquer localização.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Quais são os problemas mais comuns em Lamego?
 </h3>
 <p className="text-gray-600">
 Em Lamego, os problemas mais frequentes são entupimentos em fossas
 ...
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Atendem todo o conselho de Lamego?
 </h3>
 <p className="text-gray-600">
 Sim, servimos todo o conselho e freguesias vizinhas de Lamego.
 ...
 Canalizador em <span className="text-orange-300">Lamego</span>
 </h2>
 ...
 <CidadesProximas currentCity="Lamego" cidades={cidadesProximas} serviceType="canalizador" />
