// SEO optimizada para "Canalizador Mesão Frio"
...
export default function MesãoFrio() {
 const { config } = useSite();

 useEffect(() => {
 document.title = "Canalizador Mesão Frio 💧 24h | 928 484 451";
 ...
 metaDescription.setAttribute('content', 'Canalizador urgente em Mesão Frio. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
 ...
 canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-mesao-frio');

 const cityAddress = getCityAddress('mesao-frio');
 ...
 "geo": { "@type": "GeoCoordinates", "latitude": "41.1500", "longitude": "-7.8500" },
 ...
 const cidadesProximas = getCidadesProximas('mesao-frio');

 const faqs = [{'question': 'Qual o preço de canalizador em Mesão Frio?', 'answer': 'Desde 100€ (150 € noite/fim de semana) em Mesão Frio. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Mesão Frio?', 'answer': 'Sim, Atendimento 24h/7d, 7 dias por semana em Mesão Frio. Ligue +351 928 484 451.'}, {'question': 'Atendem a zona do Douro Superior?', 'answer': 'Sim, servimos toda a região incluindo quintas vinícolas e propriedades rurais.'}, {'question': 'Que equipamento usam?', 'answer': 'Ridgid K9-102 para desentupimentos, câmara termográfica FLIR para deteção de fugas, geofone para tubagens enterradas.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];

 return (
 <>
 <SEOHeadEnhanced citySlug="mesao-frio" pageType="city" />
 <StructuredData />
 <Header />
 ...
 { label: 'Mesão Frio', href: '/canalizador-mesao-frio' }
 ]} />
 <h1 className="text-4xl md:text-5xl font-bold mb-6">
 Canalizador Profissional em <span className="text-orange-400">Mesão Frio</span>
 </h1>
 <p className="text-xl mb-8">
 Serviços de canalização certificados em Mesão Frio e arredores.
 ...
 📞 Canalizador Mesão Frio: {config.phone}
 </a>
 <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Mesão Frio`}
 ...
 Cidade de Mesão Frio na região de Trás-os-Montes.
 </p>
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Serviços de Canalização em Mesão Frio
 </h2>
 ...
 <div className="container mx-auto px-4">
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Porquê Escolher-nos em Mesão Frio
 </h2>
 ...
 <p className="text-gray-600">
 Disponível 24h/7 dias em Mesão Frio. Atendimento 24h para urgências.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
 <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
 ...
 Perguntas sobre <span className="text-blue-600">Canalizador em Mesão Frio</span>
 </h2>
 <div className="max-w-3xl mx-auto space-y-6">
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Fazem intervenções em propriedades rurais de Mesão Frio?
 </h3>
 <p className="text-gray-600">
 Sim, temos vasta experiência em propriedades rurais, quintas e explorações
 agrícolas de Mesão Frio. Os nossos veículos têm equipamento completo
 para intervenções em qualquer localização.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Quais são os problemas mais comuns em Mesão Frio?
 </h3>
 <p className="text-gray-600">
 Em Mesão Frio, os problemas mais frequentes são entupimentos em fossas
 ...
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Atendem todo o conselho de Mesão Frio?
 </h3>
 <p className="text-gray-600">
 Sim, servimos todo o conselho e freguesias vizinhas de Mesão Frio.
 ...
 Canalizador em <span className="text-orange-300">Mesão Frio</span>
 </h2>
 ...
 <CidadesProximas currentCity="Mesão Frio" cidades={cidadesProximas} serviceType="canalizador" />
