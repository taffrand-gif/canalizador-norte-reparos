// SEO optimizada para "Canalizador Santo Estêvão"
...
export default function SantoEstêvão() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "Canalizador Santo Estêvão 💧 24h | 928 484 451";
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Santo Estêvão. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-santo-estevao');

    const cityAddress = getCityAddress('santo-estevao');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-santo-estevao';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — Santo Estêvão",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.7167", "longitude": "-7.3167" },
  ...
  const cidadesProximas = getCidadesProximas('santo-estevao');

  const faqs = [
    { question: "Qual o preço de canalizador em Santo Estêvão?", answer: "Desde 110€ em Santo Estêvão. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
    { question: "Fazem urgências em Santo Estêvão?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Santo Estêvão. Ligue +351 928 484 451." },
  ...
  return (
    <>
      <SEOHeadEnhanced citySlug="santo-estevao" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'Santo Estêvão', href: '/canalizador-santo-estevao' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">Santo Estêvão</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em Santo Estêvão e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador Santo Estêvão: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Santo Estêvão`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Santo Estêvão — Terra da Oliveira e da Serra
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Freguesia do conselho de Valpaços com tradição na olivicultura. A Serra de Bornes oferece trilhos pedestres.
              </p>
              <p className="text-gray-700">
                Zona agrícola com sistemas de irrigação tradicionais. A economia assenta na produção de azeite e cereais.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Santo Estêvão
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em Santo Estêvão</h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em Santo Estêvão. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Canalizador em <span className="text-orange-300">Santo Estêvão</span></h2>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Santo Estêvão</h2>
            <FAQSection faqs={faqs} />
          </div>
        </section>

        <CidadesProximas currentCity="Santo Estêvão" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Santo Estêvão" currentCitySlug="canalizador-santo-estevao" />
      </main>
      <Footer />
    </>
  );
