...
export default function SantoEstêvão() {
 ...
 { question: "Fazem urgências em Santo Estêvão?", answer: "Sim, Atendimento 24h/7d, 7 dias por semana em Santo Estêvão. Ligue +351 928 484 451." },
 ...
 <p className="text-gray-600">Disponível 24h/7 dias em Santo Estêvão. Atendimento 24h para urgências.</p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
