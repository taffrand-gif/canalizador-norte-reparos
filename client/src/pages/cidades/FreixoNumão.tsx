// SEO optimizada para "Canalizador Freixo de Numão"
...
export default function FreixoNumão() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "Canalizador Freixo de Numão 💧 24h | 928 484 451";
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Freixo de Numão. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-freixo-de-numao');

    const cityAddress = getCityAddress('freixo-de-numao');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-freixo-de-numao';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — Freixo de Numão",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.0000", "longitude": "-7.2667" },
  ...
  const cidadesProximas = getCidadesProximas('freixo-de-numao');
  ...
  const faqs = [
    ...
    { question: "Fazem urgências em Freixo de Numão?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Freixo de Numão. Ligue +351 928 484 451." },
  ...
  return (
    <>
      <SEOHeadEnhanced citySlug="freixo-de-numao" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'Freixo de Numão', href: '/canalizador-freixo-de-numao' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">Freixo de Numão</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em Freixo de Numão e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador Freixo de Numão: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Freixo de Numão`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Freixo de Numão — Terra da Serra de Monomir e do Xisto
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Aldeia transmontana na Serra de Monomir. Paisagens de grande beleza com vestígios de ocupação romana.
              </p>
              <p className="text-gray-700">
                Zona de xisto com economia assente na pastorícia e na exploração florestal. Os sistemas de água são frequentemente partilhados.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Freixo de Numão
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em Freixo de Numão</h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em Freixo de Numão. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Canalizador em <span className="text-orange-300">Freixo de Numão</span></h2>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Freixo de Numão</h2>
            <FAQSection faqs={faqs} />
          </div>
        </section>

        <CidadesProximas currentCity="Freixo de Numão" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Freixo de Numão" currentCitySlug="canalizador-freixo-de-numao" />
      </main>
      <Footer />
    </>
  );
