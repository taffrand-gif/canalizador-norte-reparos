...
export default function Izeda() {
 ...
 metaDescription.setAttribute('content', 'Canalizador urgente em Izeda. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
 ...
 canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-izada');

 const cityAddress = getCityAddress('izada');
 const schemaScript = document.createElement('script');
 schemaScript.type = 'application/ld+json';
 schemaScript.id = 'schema-izada';
 ...
 "geo": { "@type": "GeoCoordinates", "latitude": "41.5667", "longitude": "-6.9833" },
 ...
 { label: 'Izeda', href: '/canalizador-izada' }
 ]} />
 <h1 className="text-4xl md:text-5xl font-bold mb-6">
 Canalizador Profissional em <span className="text-orange-400">Izeda</span>
 </h1>
 <p className="text-xl mb-8">
 Serviços de canalização certificados em Izeda e arredores.
 ...
 📞 Canalizador Izeda: {config.phone}
 </a>
 <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Izeda`}
 ...
 Cidade de Izeda na região de Trás-os-Montes.
 </p>
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Serviços de Canalização em Izeda
 </h2>
 ...
 <p className="text-gray-600">
 Disponível 24h/7 dias em Izeda. Atendimento 24h para urgências.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
 <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
 ...
 Perguntas sobre <span className="text-blue-600">Canalizador em Izeda</span>
 </h2>
 <div className="max-w-3xl mx-auto space-y-6">
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Fazem intervenções em propriedades rurais de Izeda?
 </h3>
 <p className="text-gray-600">
 Sim, temos vasta experiência em propriedades rurais, quintas e explorações
 agrícolas de Izeda. Os nossos veículos têm equipamento completo
 para intervenções em qualquer localização.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Quais são os problemas mais comuns em Izeda?
 </h3>
 <p className="text-gray-600">
 Em Izeda, os problemas mais frequentes são entupimentos em fossas
 ...
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Atendem todo o conselho de Izeda?
 </h3>
 <p className="text-gray-600">
 Sim, servimos todo o conselho e freguesias vizinhas de Izeda.
 ...
 Canalizador em <span className="text-orange-300">Izeda</span>
 </h2>
 ...
 <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Izeda</h2>
 <FAQSection faqs={faqs} />
 </div>
 </section>

 <CidadesProximas currentCity="Izeda" cidades={cidadesProximas} serviceType="canalizador" />
 <RelatedCities currentCity="Izeda" currentCitySlug="canalizador-izada" />
 </main>
 <Footer />
 </>
 );
