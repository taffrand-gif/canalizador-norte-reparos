...
export default function VilaPoucaAguiar() {
  ...
  const faqs = [{'question': 'Qual o preço de canalizador em Vila Pouca de Aguiar?', 'answer': 'Desde 120€ em Vila Pouca de Aguiar. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Vila Pouca de Aguiar?', 'answer': 'Sim, atendimento 24 horas, 7 dias por semana em Vila Pouca de Aguiar. Ligue +351 928 484 451.'}, {'question': 'Chegam a propriedades no Douro Superior?', 'answer': 'Sim, servimos toda a região vinhateira incluindo quintas e adegas. Equipamento completo para intervenções.'}, {'question': 'Trabalham em quintas e explorações agrícolas?', 'answer': 'Sim, temos vasta experiência em sistemas de água para agricultura, irrigação e consumo animal.'}, {'question': 'Têm garantia?', 'answer': 'Sim, todas as intervenções têm garantia escrita de 12 meses, peças e mão de obra.'}];
