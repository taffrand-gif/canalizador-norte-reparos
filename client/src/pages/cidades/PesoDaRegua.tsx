...
<p data-p1="answer-first" style={{ background: "#fff5e0", borderLeft: "4px solid #FF6B35",
  ...
  Em Peso da Régua, a deslocação é 65€ (Zona 6, 98.4 km de Macedo de Cavaleiros). Mão de obra 65 €/h, orçamento por escrito antes de qualquer trabalho. Contacto: <a href="tel:+351****4451" style={{ color: "#FF6B35", fontWeight: "bold", textDecoration: "none" }}>928 484 451</a>.
</p>
 ...
 <p className="text-gray-600">Disponível 24h/7 dias em Peso da Régua. Atendimento 24h para urgências.</p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
