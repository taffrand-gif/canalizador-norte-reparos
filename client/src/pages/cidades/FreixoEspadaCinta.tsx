...
// 100% unique content, zone Z6, preço 100€
...
export default function FreixoEspadaCinta() {
 ...
 const faqs = [
 { question: "Qual o preço de canalizador em Freixo de Espada à Cinta?", answer: "Desde 100€ em Freixo de Espada à Cinta. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
 { question: "Fazem urgências em Freixo de Espada à Cinta?", answer: "Sim, Atendimento 24h/7d, 7 dias por semana em Freixo de Espada à Cinta. Ligue +351 928 484 451." },
...
<p data-p1="answer-first" style={{ background: "#fff5e0", borderLeft: "4px solid #FF6B35",
  ...
  Em Freixo de Espada à Cinta, a deslocação é 65€ (Zona 6, 94 km de Macedo de Cavaleiros). Mão de obra 65 €/h, orçamento por escrito antes de qualquer trabalho. Contacto: <a href="tel:+351928484451" style={{ color: "#FF6B35", fontWeight: "bold", textDecoration: "none" }}>928 484 451</a>.
</p>
 ...
 <p className="text-gray-600">Disponível 24h/7 dias em Freixo de Espada à Cinta. Atendimento 24h para urgências.</p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
