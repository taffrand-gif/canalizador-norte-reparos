...
export default function FreixoEspadaCinta() {
  ...
  const faqs = [
    ...
    { question: "Fazem urgências em Freixo de Espada à Cinta?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Freixo de Espada à Cinta. Ligue +351 928 484 451." },
