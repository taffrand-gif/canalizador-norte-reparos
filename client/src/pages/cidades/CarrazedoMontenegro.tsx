...
export default function CarrazedoMontenegro() {
  ...
  const faqs = [
    ...
    { question: "Fazem urgências em Carrazedo de Montenegro?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Carrazedo de Montenegro. Ligue +351 928 484 451." },
