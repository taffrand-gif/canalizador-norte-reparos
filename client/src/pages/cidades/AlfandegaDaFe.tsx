...
export default function AlfandegaDaFe() {
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://norte-reparos.com/canalizador-alfandega-da-fe');
    ...
    schemaScript.text = JSON.stringify({
      ...
      "address": { "@type": "PostalAddress", "addressLocality": "Alfândega da Fé", "addressRegion": "Bragança", "addressCountry": "PT" },
        ...
        <section className="relative py-20 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/images-optimized/hero/hero-plumber-portugal.jpg')` }}>
          <div className="container text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/351928484451?text=Olá,%20preciso%20de%20um%20canalizador%20em%20Alfândega%20da%20Fé" className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg text-xl font-bold transition-all shadow-lg">💬 WhatsApp</a>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {[
                ...
                { icon: Wrench, title: "Reparação de Fugas", desc: "Deteção e reparação de fugas em casas antigas e canalizações rurais" },
                { icon: CheckCircle, title: "Instalação de Esquentadores", desc: "Montagem e reparação de esquentadores para casas de aldeia" },
              ].map((service, index) => (
