...
export default function VilaNovaFozCôa() {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Vila Nova de Foz Côa. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-vila-nova-de-foz-coa');

    const cityAddress = getCityAddress('vila-nova-de-foz-coa');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-vila-nova-de-foz-coa';
    schemaScript.text = JSON.stringify({
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "40.9833", "longitude": "-7.1333" },
  ...
  const faqs = [{'question': 'Qual o preço de canalizador em Vila Nova de Foz Côa?', 'answer': 'Desde 110€ em Vila Nova de Foz Côa. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Vila Nova de Foz Côa?', 'answer': 'Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Vila Nova de Foz Côa. Ligue +351 928 484 451.'}, {'question': 'Atendem propriedades rurais em Vila Nova de Foz Côa?', 'answer': 'Sim, servimos todo o conselho incluindo propriedades rurais e aldeias isoladas.'}, {'question': 'Têm câmara termográfica para deteção de fugas?', 'answer': 'Sim, utilizamos câmara termográfica FLIR e geofone para localização precisa de fugas sem demolição.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];

  return (
    <>
      <SEOHeadEnhanced citySlug="vila-nova-de-foz-coa" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'Vila Nova de Foz Côa', href: '/canalizador-vila-nova-de-foz-coa' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">Vila Nova de Foz Côa</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em Vila Nova de Foz Côa e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador Vila Nova de Foz Côa: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Vila Nova de Foz Côa`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Vila Nova de Foz Côa — Terra das Gravuras Rupestres
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Património Mundial da UNESCO com mais de 600 grabados rupestres. A região do Douro Superior é conhecida pelos grandes tintos.
              </p>
              <p className="text-gray-700">
                Turismo cultural em crescimento grauit ao Programa de Desenvolvimento Rural. Os sistemas de água para quintas e turismo rural são frequentes.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Vila Nova de Foz Côa
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Porquê Escolher-nos em Vila Nova de Foz Côa
            </h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Resposta rápida em Vila Nova de Foz Côa. Atendimento 24h para urgências.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Perguntas sobre <span className="text-blue-600">Canalizador em Vila Nova de Foz Côa</span>
            </h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Fazem intervenções em propriedades rurais de Vila Nova de Foz Côa?
                </h3>
                <p className="text-gray-600">
                  Sim, temos vasta experiência em propriedades rurais, quintas e explorações
                  agrícolas de Vila Nova de Foz Côa. Os nossos veículos têm equipamento completo
                  para intervenções em qualquer localização.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Quais são os problemas mais comuns em Vila Nova de Foz Côa?
                </h3>
                <p className="text-gray-600">
                  Em Vila Nova de Foz Côa, os problemas mais frequentes são entupimentos em fossas
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Atendem todo o conselho de Vila Nova de Foz Côa?
                </h3>
                <p className="text-gray-600">
                  Sim, servimos todo o conselho e freguesias vizinhas de Vila Nova de Foz Côa.
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">
              Canalizador em <span className="text-orange-300">Vila Nova de Foz Côa</span>
            </h2>
        ...
        <CidadesProximas currentCity="Vila Nova de Foz Côa" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Vila Nova de Foz Côa" currentCitySlug="canalizador-vila-nova-de-foz-coa" />
      </main>
      <Footer />
    </>
  );
