// SEO optimizada para "Canalizador São Martinho de Anta"
...
export default function SãoMartinhoAnta() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "Canalizador São Martinho de Anta 💧 24h | 928 484 451";
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em São Martinho de Anta. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-sao-martinho-de-anta');

    const cityAddress = getCityAddress('sao-martinho-de-anta');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-sao-martinho-de-anta';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — São Martinho de Anta",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.3333", "longitude": "-7.5500" },
  ...
  const cidadesProximas = getCidadesProximas('sao-martinho-de-anta');

  const faqs = [
    { question: "Qual o preço de canalizador em São Martinho de Anta?", answer: "Desde 120€ em São Martinho de Anta. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
    { question: "Fazem urgências em São Martinho de Anta?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em São Martinho de Anta. Ligue +351 928 484 451." },
  ...
  return (
    <>
      <SEOHeadEnhanced citySlug="sao-martinho-de-anta" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'São Martinho de Anta', href: '/canalizador-sao-martinho-de-anta' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">São Martinho de Anta</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em São Martinho de Anta e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador São Martinho de Anta: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em São Martinho de Anta`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              São Martinho de Anta — Terra do Douro e do São Martinho
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Freguesia vinhateira do Douro. Conhecida pelos seus solares e pela produção de vinho do Porto.
              </p>
              <p className="text-gray-700">
                Zona de grande tradição vinícola. A produção de vinho exige sistemas de água de qualidade para adegas.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em São Martinho de Anta
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em São Martinho de Anta</h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em São Martinho de Anta. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Canalizador em <span className="text-orange-300">São Martinho de Anta</span></h2>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - São Martinho de Anta</h2>
            <FAQSection faqs={faqs} />
          </div>
        </section>

        <CidadesProximas currentCity="São Martinho de Anta" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="São Martinho de Anta" currentCitySlug="canalizador-sao-martinho-de-anta" />
      </main>
      <Footer />
    </>
  );
