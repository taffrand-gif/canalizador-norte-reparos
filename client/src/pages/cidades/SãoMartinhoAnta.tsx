...
export default function SãoMartinhoAnta() {
 ...
 { question: "Fazem urgências em São Martinho de Anta?", answer: "Sim, Atendimento 24h/7d, 7 dias por semana em São Martinho de Anta. Ligue +351 928 484 451." },
 ...
 <p className="text-gray-600">Disponível 24h/7 dias em São Martinho de Anta. Atendimento 24h para urgências.</p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
