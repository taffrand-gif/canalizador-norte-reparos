...
export default function SanfinsDouro() {
 ...
 { question: "Fazem urgências em Sanfins do Douro?", answer: "Sim, Atendimento 24h/7d, 7 dias por semana em Sanfins do Douro. Ligue +351 928 484 451." },
 ...
 <p className="text-gray-600">Disponível 24h/7 dias em Sanfins do Douro. Atendimento 24h para urgências.</p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
