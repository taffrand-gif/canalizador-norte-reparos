...
export default function Chaves() {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Chaves. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    schemaScript.id = 'schema-chaves';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — Chaves",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.7333", "longitude": "-7.4667" },
  ...
  const faqs = [{'question': 'Qual o preço de canalizador em Chaves?', 'answer': 'Desde 110€ em Chaves. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Chaves?', 'answer': 'Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Chaves. Ligue +351 928 484 451.'}, {'question': 'Atendem propriedades rurais em Chaves?', 'answer': 'Sim, servimos todo o conselho incluindo propriedades rurais e aldeias isoladas.'}, {'question': 'Têm câmara termográfica para deteção de fugas?', 'answer': 'Sim, utilizamos câmara termográfica FLIR e geofone para localização precisa de fugas sem demolição.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];

  return (
    <>
      <SEOHeadEnhanced citySlug="chaves" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              ...
              <p className="text-xl mb-8">
                Serviços de canalização certificados em Chaves e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Chaves`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Chaves — Terra das Termas e da Ponte de Traição
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Conhecida pelas águas termais medicinais desde a época romana. A Ponte de Traição sobre o Rio Tâmega é símbolo da cidade.
              </p>
              <p className="text-gray-700">
                Estância térmica privilegiada com tradição na exploração de águas mineromedicinais. Economia assente no turismo termal e na agricultura.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Chaves
              </h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Resposta rápida em Chaves. Atendimento 24h para urgências.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Fazem intervenções em propriedades rurais de Chaves?
                </h3>
                <p className="text-gray-600">
                  Sim, temos vasta experiência em propriedades rurais, quintas e explorações
                  agrícolas de Chaves. Os nossos veículos têm equipamento completo
                  para intervenções em qualquer localização.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Quais são os problemas mais comuns em Chaves?
                </h3>
                <p className="text-gray-600">
                  Em Chaves, os problemas mais frequentes são entupimentos em fossas
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Atendem todo o conselho de Chaves?
                </h3>
                <p className="text-gray-600">
                  Sim, servimos todo o conselho e freguesias vizinhas de Chaves.
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">
              Canalizador em <span className="text-orange-300">Chaves</span>
            </h2>
        ...
        <CidadesProximas currentCity="Chaves" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Chaves" currentCitySlug="canalizador-chaves" />
      </main>
      <Footer />
    </>
  );
