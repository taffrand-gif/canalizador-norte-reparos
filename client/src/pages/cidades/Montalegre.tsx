...
export default function Montalegre() {
  ...
  const faqs = [{'question': 'Qual o preço de canalizador em Montalegre?', 'answer': 'Desde 130€ em Montalegre. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Montalegre?', 'answer': 'Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Montalegre. Ligue +351 928 484 451.'}, {'question': 'Atendem a zona do Douro Superior?', 'answer': 'Sim, servimos toda a região incluindo quintas vinícolas e propriedades rurais.'}, {'question': 'Que equipamento usam?', 'answer': 'Ridgid K9-102 para desentupimentos, câmara termográfica FLIR para deteção de fugas, geofone para tubagens enterradas.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Resposta rápida em Montalegre. Atendimento 24h para urgências.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
