// SEO optimizada para "Canalizador Penedono"
...
export default function Penedono() {
 ...
 metaDescription.setAttribute('content', 'Canalizador urgente em Penedono. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
 ...
 "geo": { "@type": "GeoCoordinates", "latitude": "40.9833", "longitude": "-7.4000" },
 ...
 const faqs = [{'question': 'Qual o preço de canalizador em Penedono?', 'answer': 'Desde 100€ (150 € noite/fim de semana) em Penedono. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Penedono?', 'answer': 'Sim, Atendimento 24h/7d, 7 dias por semana em Penedono. Ligue +351 928 484 451.'}, {'question': 'Chegam a propriedades no Douro Superior?', 'answer': 'Sim, servimos toda a região vinhateira incluindo quintas e adegas. Equipamento completo para intervenções.'}, {'question': 'Trabalham em quintas e explorações agrícolas?', 'answer': 'Sim, temos vasta experiência em sistemas de água para agricultura, irrigação e consumo animal.'}, {'question': 'Têm garantia?', 'answer': 'Sim, todas as intervenções têm garantia escrita de 12 meses, peças e mão de obra.'}];

 return (
 <>
 <SEOHeadEnhanced citySlug="penedono" pageType="city" />
 <StructuredData />
 <Header />
 ...
 { label: 'Penedono', href: '/canalizador-penedono' }
 ]} />
 <h1 className="text-4xl md:text-5xl font-bold mb-6">
 Canalizador Profissional em <span className="text-orange-400">Penedono</span>
 </h1>
 <p className="text-xl mb-8">
 Serviços de canalização certificados em Penedono e arredores.
 ...
 📞 Canalizador Penedono: {config.phone}
 </a>
 <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Penedono`}
 ...
 Cidade de Penedono na região de Trás-os-Montes.
 </p>
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Serviços de Canalização em Penedono
 </h2>
 ...
 <div className="container mx-auto px-4">
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Porquê Escolher-nos em Penedono
 </h2>
 ...
 <p className="text-gray-600">
 Disponível 24h/7 dias em Penedono. Atendimento 24h para urgências.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
 <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
 ...
 Perguntas sobre <span className="text-blue-600">Canalizador em Penedono</span>
 </h2>
 <div className="max-w-3xl mx-auto space-y-6">
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Fazem intervenções em propriedades rurais de Penedono?
 </h3>
 <p className="text-gray-600">
 Sim, temos vasta experiência em propriedades rurais, quintas e explorações
 agrícolas de Penedono. Os nossos veículos têm equipamento completo
 para intervenções em qualquer localização.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Quais são os problemas mais comuns em Penedono?
 </h3>
 <p className="text-gray-600">
 Em Penedono, os problemas mais frequentes são entupimentos em fossas
 ...
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Atendem todo o conselho de Penedono?
 </h3>
 <p className="text-gray-600">
 Sim, servimos todo o conselho e freguesias vizinhas de Penedono.
 ...
 Canalizador em <span className="text-orange-300">Penedono</span>
 </h2>
 ...
 <CidadesProximas currentCity="Penedono" cidades={cidadesProximas} serviceType="canalizador" />
