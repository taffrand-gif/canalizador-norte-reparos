...
export default function Cedovim() {
  const faqs = [
    {
      ...
      answer: "Em Cedovim, a deslocação é de 30€ (zona de cobertura a partir de Macedo de Cavaleiros). A mão de obra é 70€/h. Mínimo faturado: 100 € em dias úteis e 150 € à noite, fins de semana e feriados (deslocação + 1 hora; cada hora começada é devida). O preço é sempre comunicado antes de qualquer intervenção."
    },
    {
    ...
    },
    {
      ...
      answer: "Sim, estamos disponíveis ao fim de semana e feriados para reparação de fugas de água em Cedovim. A deslocação é de 30€. Ligue 928 484 451."
    },
    {
      question: "Que zonas cobrem a partir de Cedovim?",
      answer: "A partir de Cedovim cobrimos toda a zona de Vila Nova de Foz Côa e arredores. Disponíveis 24h incluindo fins de semana e feriados. Deslocação 30€."
    }
  ];
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', 'Canalizador em Cedovim — desentupimentos, fugas de água, instalações sanitárias. Urgências 24h. Deslocação 30€. Ligue 928 484 451.');
