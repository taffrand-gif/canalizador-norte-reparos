...
export default function SãoCosmado() {
  ...
  const faqs = [{'question': 'Qual o preço de canalizador em São Cosmado?', 'answer': 'Desde 130€ em São Cosmado. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em São Cosmado?', 'answer': 'Sim, atendimento 24 horas, 7 dias por semana em São Cosmado. Ligue +351 928 484 451.'}, {'question': 'Atendem a zona do Douro Superior?', 'answer': 'Sim, servimos toda a região incluindo quintas vinícolas e propriedades rurais.'}, {'question': 'Que equipamento usam?', 'answer': 'Ridgid K-6200 para desentupimentos, câmara termográfica FLIR para deteção de fugas, geofone para tubagens enterradas.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];
