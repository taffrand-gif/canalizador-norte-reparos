// SEO optimizada para "Canalizador São Cosmado"
...
export default function SãoCosmado() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "Canalizador São Cosmado 💧 24h | 928 484 451";
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em São Cosmado. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-sao-cosmao');

    const cityAddress = getCityAddress('sao-cosmao');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-sao-cosmao';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — São Cosmado",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.0500", "longitude": "-7.6500" },
  ...
  const cidadesProximas = getCidadesProximas('sao-cosmao');

  const faqs = [{'question': 'Qual o preço de canalizador em São Cosmado?', 'answer': 'Desde 130€ em São Cosmado. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em São Cosmado?', 'answer': 'Sim, atendimento Atendimento 24h/7d, 7 dias por semana em São Cosmado. Ligue +351 928 484 451.'}, {'question': 'Atendem a zona do Douro Superior?', 'answer': 'Sim, servimos toda a região incluindo quintas vinícolas e propriedades rurais.'}, {'question': 'Que equipamento usam?', 'answer': 'Ridgid K9-102 para desentupimentos, câmara termográfica FLIR para deteção de fugas, geofone para tubagens enterradas.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];

  return (
    <>
      <SEOHeadEnhanced citySlug="sao-cosmao" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'São Cosmado', href: '/canalizador-sao-cosmao' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">São Cosmado</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em São Cosmado e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador São Cosmado: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em São Cosmado`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              São Cosmado — São Cosmado
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Cidade de São Cosmado na região de Trás-os-Montes.
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em São Cosmado
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Porquê Escolher-nos em São Cosmado
            </h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Resposta rápida em São Cosmado. Atendimento 24h para urgências.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Perguntas sobre <span className="text-blue-600">Canalizador em São Cosmado</span>
            </h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Fazem intervenções em propriedades rurais de São Cosmado?
                </h3>
                <p className="text-gray-600">
                  Sim, temos vasta experiência em propriedades rurais, quintas e explorações
                  agrícolas de São Cosmado. Os nossos veículos têm equipamento completo
                  para intervenções em qualquer localização.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Quais são os problemas mais comuns em São Cosmado?
                </h3>
                <p className="text-gray-600">
                  Em São Cosmado, os problemas mais frequentes são entupimentos em fossas
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Atendem todo o conselho de São Cosmado?
                </h3>
                <p className="text-gray-600">
                  Sim, servimos todo o conselho e freguesias vizinhas de São Cosmado.
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">
              Canalizador em <span className="text-orange-300">São Cosmado</span>
            </h2>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - São Cosmado</h2>
            <FAQSection faqs={faqs} />
          </div>
        </section>

        <CidadesProximas currentCity="São Cosmado" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="São Cosmado" currentCitySlug="canalizador-sao-cosmao" />
      </main>
      <Footer />
    </>
  );
