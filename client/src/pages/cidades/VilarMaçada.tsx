// SEO optimizada para "Canalizador Vilar de Maçada"
...
export default function VilarMaçada() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "Canalizador Vilar de Maçada 💧 24h | 928 484 451";
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Vilar de Maçada. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-vilar-de-macada');

    const cityAddress = getCityAddress('vilar-de-macada');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-vilar-de-macada';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — Vilar de Maçada",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "41.2667", "longitude": "-7.5000" },
  ...
  const cidadesProximas = getCidadesProximas('vilar-de-macada');

  const faqs = [
    { question: "Qual o preço de canalizador em Vilar de Maçada?", answer: "Desde 110€ em Vilar de Maçada. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
    { question: "Fazem urgências em Vilar de Maçada?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Vilar de Maçada. Ligue +351 928 484 451." },
  ...
  return (
    <>
      <SEOHeadEnhanced citySlug="vilar-de-macada" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'Vilar de Maçada', href: '/canalizador-vilar-de-macada' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">Vilar de Maçada</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em Vilar de Maçada e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador Vilar de Maçada: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Vilar de Maçada`}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Vilar de Maçada — Terra do Vinho Verde e da Oliveira
            </h2>
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Povoação do Douro Superior conhecida pela produção de vinho verde e azeite. Paisagens deslumbrantes sobre o vale do Douro.
              </p>
              <p className="text-gray-700">
                Zona de transição entre Trás-os-Montes e o Douro. A agricultura e o turismo rural são pilares da economia local.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Vilar de Maçada
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em Vilar de Maçada</h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em Vilar de Maçada. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Canalizador em <span className="text-orange-300">Vilar de Maçada</span></h2>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Vilar de Maçada</h2>
            <FAQSection faqs={faqs} />
          </div>
        </section>

        <CidadesProximas currentCity="Vilar de Maçada" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Vilar de Maçada" currentCitySlug="canalizador-vilar-de-macada" />
      </main>
      <Footer />
    </>
  );
