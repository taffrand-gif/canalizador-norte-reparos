// SEO optimizada para "Canalizador Tabuaço"
...
export default function Tabuaco() {
 ...
 metaDescription.setAttribute('content', 'Canalizador urgente em Tabuaço. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
 ...
 const faqs = [
 { question: "Qual o preço de canalizador em Tabuaço?", answer: "Desde 100€ (150 € noite/fim de semana) em Tabuaço. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
 { question: "Fazem urgências em Tabuaço?", answer: "Sim, Atendimento 24h/7d, 7 dias por semana em Tabuaço. Ligue +351 928 484 451." },
 ...
 return (
 <>
 <SEOHeadEnhanced citySlug="tabuaco" pageType="city" />
 <StructuredData />
 <Header />
 ...
 { label: 'Tabuaço', href: '/canalizador-tabuaco' }
 ]} />
 <h1 className="text-4xl md:text-5xl font-bold mb-6">
 Canalizador Profissional em <span className="text-orange-400">Tabuaço</span>
 </h1>
 <p className="text-xl mb-8">
 Serviços de canalização certificados em Tabuaço e arredores.
 ...
 📞 Canalizador Tabuaço: {config.phone}
 </a>
 <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Tabuaço`}
 ...
 Tabuaço — Terra do Vinho do Porto e da Serra
 </h2>
 <div className="max-w-4xl mx-auto">
 <p className="text-gray-700 mb-4">
 Concelho vinhateiro do Douro Superior. As quintas produzem alguns dos melhores vinhos do mundo.
 </p>
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Serviços de Canalização em Tabuaço
 </h2>
 ...
 <div className="container mx-auto px-4">
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Porquê Escolher-nos em Tabuaço</h2>
 ...
 <p className="text-gray-600">Disponível 24h/7 dias em Tabuaço. Atendimento 24h para urgências.</p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
 ...
 <h2 className="text-3xl font-bold mb-6">Canalizador em <span className="text-orange-300">Tabuaço</span></h2>
 ...
 <CidadesProximas currentCity="Tabuaço" cidades={cidadesProximas} serviceType="canalizador" />
