...
export default function Tabuaco() {
 ...
 const faqs = [
 { question: "Qual o preço de canalizador em Tabuaço?", answer: "Desde 120€ em Tabuaço. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
