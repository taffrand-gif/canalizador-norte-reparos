        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">Cobrimos Moucos e toda a área de Santa Marta de Penaguião. Deslocação 55€ (Zona 5). Mão de obra 65€/h. Orçamento por escrito.</p>
            </div>
