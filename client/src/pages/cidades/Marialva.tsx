// SEO optimizada para "Canalizador Marialva"
...
export default function Marialva() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "Canalizador Marialva 💧 24h | 928 484 451";
    ...
    metaDescription.setAttribute('content', 'Canalizador urgente em Marialva. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-marialva');

    const cityAddress = getCityAddress('marialva');
    const schemaScript = document.createElement('script');
    schemaScript.type = 'application/ld+json';
    schemaScript.id = 'schema-marialva';
    schemaScript.text = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "Canalizador Profissional — Marialva",
      "address": {
        "@type": "PostalAddress",
      ...
      "geo": { "@type": "GeoCoordinates", "latitude": "40.9667", "longitude": "-7.2833" },
  ...
  const cidadesProximas = getCidadesProximas('marialva');

  const faqs = [{'question': 'Qual o preço de canalizador em Marialva?', 'answer': 'Desde 120€ em Marialva. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Marialva?', 'answer': 'Sim, atendimento Atendimento 24h/7d, 7 dias por semana em Marialva. Ligue +351 928 484 451.'}, {'question': 'Chegam a propriedades no Douro Superior?', 'answer': 'Sim, servimos toda a região vinhateira incluindo quintas e adegas. Equipamento completo para intervenções.'}, {'question': 'Trabalham em quintas e explorações agrícolas?', 'answer': 'Sim, temos vasta experiência em sistemas de água para agricultura, irrigação e consumo animal.'}, {'question': 'Têm garantia?', 'answer': 'Sim, todas as intervenções têm garantia escrita de 12 meses, peças e mão de obra.'}];

  return (
    <>
      <SEOHeadEnhanced citySlug="marialva" pageType="city" />
      <StructuredData />
      <Header />
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <Breadcrumbs items={[
                ...
                { label: 'Marialva', href: '/canalizador-marialva' }
              ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Canalizador Profissional em <span className="text-orange-400">Marialva</span>
              </h1>
              <p className="text-xl mb-8">
                Serviços de canalização certificados em Marialva e arredores.
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href={`tel:+351${config.phone.replace(/\s/g, "")}`}
                  ...
                  📞 Canalizador Marialva: {config.phone}
                </a>
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Marialva`}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-gray-700 mb-4">
                Cidade de Marialva na região de Trás-os-Montes.
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Serviços de Canalização em Marialva
              </h2>
        ...
        <section className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Porquê Escolher-nos em Marialva
            </h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">
                  Resposta rápida em Marialva. Atendimento 24h para urgências.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Perguntas sobre <span className="text-blue-600">Canalizador em Marialva</span>
            </h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Fazem intervenções em propriedades rurais de Marialva?
                </h3>
                <p className="text-gray-600">
                  Sim, temos vasta experiência em propriedades rurais, quintas e explorações
                  agrícolas de Marialva. Os nossos veículos têm equipamento completo
                  para intervenções em qualquer localização.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Quais são os problemas mais comuns em Marialva?
                </h3>
                <p className="text-gray-600">
                  Em Marialva, os problemas mais frequentes são entupimentos em fossas
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Atendem todo o conselho de Marialva?
                </h3>
                <p className="text-gray-600">
                  Sim, servimos todo o conselho e freguesias vizinhas de Marialva.
        ...
        <section className="py-16 bg-gradient-to-r from-orange-500 to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">
              Canalizador em <span className="text-orange-300">Marialva</span>
            </h2>
        ...
        <section className="py-16">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Marialva</h2>
            <FAQSection faqs={faqs} />
          </div>
        </section>

        <CidadesProximas currentCity="Marialva" cidades={cidadesProximas} serviceType="canalizador" />
        <RelatedCities currentCity="Marialva" currentCitySlug="canalizador-marialva" />
      </main>
      <Footer />
    </>
  );
