...
export default function SãoJoãoPesqueira() {
  ...
  const faqs = [
    { question: "Qual o preço de canalizador em São João da Pesqueira?", answer: "Desde 120€ em São João da Pesqueira. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso." },
    { question: "Fazem urgências em São João da Pesqueira?", answer: "Sim, atendimento Atendimento 24h/7d, 7 dias por semana em São João da Pesqueira. Ligue +351 928 484 451." },
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600">Resposta rápida em São João da Pesqueira. Atendimento 24h para urgências.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
