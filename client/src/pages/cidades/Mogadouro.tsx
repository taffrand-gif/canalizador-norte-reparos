...
export default function Mogadouro() {
 ...
 metaDescription.setAttribute('content', 'Canalizador urgente em Mogadouro. Desentupimentos e arranjos, orçamento sem compromisso. Ligue: 928 484 451');
 ...
 "geo": { "@type": "GeoCoordinates", "latitude": "41.3500", "longitude": "-6.7500" },
 ...
 const faqs = [{'question': 'Qual o preço de canalizador em Mogadouro?', 'answer': 'Desde 100€ em Mogadouro. Desentupimentos, arranjo de fugas, instalação sanitários. Orçamento sem compromisso.'}, {'question': 'Fazem urgências em Mogadouro?', 'answer': 'Sim, Atendimento 24h/7d, 7 dias por semana em Mogadouro. Ligue +351 928 484 451.'}, {'question': 'Atendem propriedades rurais em Mogadouro?', 'answer': 'Sim, servimos todo o conselho incluindo propriedades rurais e aldeias isoladas.'}, {'question': 'Têm câmara termográfica para deteção de fugas?', 'answer': 'Sim, utilizamos câmara termográfica FLIR e geofone para localização precisa de fugas sem demolição.'}, {'question': 'Fornecem factura com NIF?', 'answer': 'Sim, todas as intervenções incluem factura com NIF para efeitos fiscais e de seguro.'}];

 return (
 <>
 <SEOHeadEnhanced citySlug="mogadouro" pageType="city" />
 <StructuredData />
 <Header />
...
<p data-p1="answer-first" style={{ background: "#fff5e0", borderLeft: "4px solid #FF6B35",
  ...
  Em Mogadouro, a deslocação é 35€ (Zona 3, 48.5 km de Macedo de Cavaleiros). Mão de obra 65 €/h, orçamento por escrito antes de qualquer trabalho. Contacto: <a href="tel:+351****4451" style={{ color: "#FF6B35", fontWeight: "bold", textDecoration: "none" }}>928 484 451</a>.
</p>
 ...
 { label: 'Mogadouro', href: '/canalizador-mogadouro' }
 ]} />
 <h1 className="text-4xl md:text-5xl font-bold mb-6">
 Canalizador Profissional em <span className="text-orange-400">Mogadouro</span>
 </h1>
 <p className="text-xl mb-8">
 Serviços de canalização certificados em Mogadouro e arredores.
 ...
 📞 Canalizador Mogadouro: {config.phone}
 </a>
 <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador em Mogadouro`}
 ...
 Mogadouro — Terra do Fumeiro e das Quintas
 </h2>
 <div className="max-w-4xl mx-auto">
 <p className="text-gray-700 mb-4">
 Concelho do Douro Superior conhecido pelos produtos transmontanos. As quintas produzem azeite, vinho e fumeiro de qualidade.
 </p>
 <p className="text-gray-700">
 Zona fronteiriça com grande tradição agrícola. As propriedades dispersas criam necessidades específicas de sistemas de água individuais.
 </p>
 </div>
 </div>
 </section>
 ...
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Serviços de Canalização em Mogadouro
 </h2>
 ...
 <div className="container mx-auto px-4">
 <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
 Porquê Escolher-nos em Mogadouro
 </h2>
 ...
 <p className="text-gray-600">
 Disponível 24h/7 dias em Mogadouro. Atendimento 24h para urgências.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg">
 <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-3">
 ...
 Perguntas sobre <span className="text-blue-600">Canalizador em Mogadouro</span>
 </h2>
 <div className="max-w-3xl mx-auto space-y-6">
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Fazem intervenções em propriedades rurais de Mogadouro?
 </h3>
 <p className="text-gray-600">
 Sim, temos vasta experiência em propriedades rurais, quintas e explorações
 agrícolas de Mogadouro. Os nossos veículos têm equipamento completo
 para intervenções em qualquer localização.
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Quais são os problemas mais comuns em Mogadouro?
 </h3>
 <p className="text-gray-600">
 Em Mogadouro, os problemas mais frequentes são entupimentos em fossas
 ...
 <div className="bg-white p-6 rounded-xl shadow-md">
 <h3 className="text-xl font-bold text-gray-900 mb-3">
 Atendem todo o conselho de Mogadouro?
 </h3>
 <p className="text-gray-600">
 Sim, servimos todo o conselho e freguesias vizinhas de Mogadouro.
 ...
 Canalizador em <span className="text-orange-300">Mogadouro</span>
 </h2>
 ...
 <h2 className="text-3xl font-black text-center mb-12">Perguntas Frequentes - Mogadouro</h2>
 <FAQSection faqs={faqs} />
 </div>
 </section>

 <CidadesProximas currentCity="Mogadouro" cidades={cidadesProximas} serviceType="canalizador" />
 <RelatedCities currentCity="Mogadouro" currentCitySlug="canalizador-mogadouro" />
 </main>
 <Footer />
 </>
 );
