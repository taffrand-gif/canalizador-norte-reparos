...
export default function Pinhao() {
  const faqs = [
    {
      ...
      answer: "Em Pinhão, a deslocação é de 30€. A mão de obra é 70€/h. Mínimo faturado: 100 € em dias úteis e 150 € à noite, fins de semana e feriados (deslocação + 1 hora; cada hora começada é devida). O preço é sempre comunicado antes de qualquer intervenção."
    },
    {
    ...
    },
    {
      ...
      answer: "Sim, fazemos desentupimentos de esgotos, lavatórios, sanitas e ralos em Pinhão. Somos especialistas em adegas, quintas vínicolas e casas históricas do Douro com canalizações antigas. Orçamento por escrito antes de qualquer trabalho."
    },
    {
      question: "Reparam fugas de água ao fim de semana em Pinhão?",
      answer: "Sim, atendemos fugas de água em Pinhão 24h, incluindo fins de semana e feriados. Dias úteis (9h–17h): mão de obra 70 €/hora e deslocação 30 €. Noite (17h–9h), fins de semana e feriados: 100 €/hora e deslocação 50 €."
    },
    {
  ...
  useEffect(() => {
    ...
    md.setAttribute('content', 'Canalizador em Pinhão, Vila Real. Desentupimentos, fugas de água, instalações sanitárias. Deslocação 30€. Urgências 24h. Ligue 928 484 451.');
    ...
    s.text = JSON.stringify({
      ...
      "description": "Canalizador profissional em Pinhão, Vila Real. Desentupimentos, fugas e urgências 24h. Deslocação 30€.",
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50">
        <section className="bg-gradient-to-r from-gray-900 to-blue-800 text-white py-16">
          <div className="container mx-auto px-4"><div className="max-w-4xl">
            ...
            <p className="text-xl mb-4 text-gray-200">Vila fluvial do concelho de Alijó, no coração da Região Demarcada do Douro, com quintas vínicolas centenárias. Urgências 24h, desentupimentos e fugas de água. Deslocação 30€.</p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">Cobrimos Pinhão e toda a área de Alijó. Deslocação 30€. Mão de obra 70€/h. Orçamento por escrito.</p>
            </div>
