...
export default function SantaMartaPenaguião() {
  ...
  const faqs = [
    ...
    { question: "Fazem urgências em Santa Marta de Penaguião?", answer: "Sim, atendimento 24 horas, 7 dias por semana em Santa Marta de Penaguião. Ligue +351 928 484 451." },
