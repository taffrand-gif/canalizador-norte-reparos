...
function Urgencia() {
 ...
 <>
 <Helmet>
 <title>Urgência Canalizador — Intervenção mediante confirmação 24h | Norte Reparos</title>
 ...
 <a
 href={`https://wa.me/${whatsapp}?text=URGÊNCIA%20-%20Preciso%20de%20canalizador%20JÁ`}
 target="_blank"
 ...
 <div className="text-sm">Equipamento</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <span>Infiltração progressiva nas paredes</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
 <span>Danos estruturais que se agravam</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
 <span>Bolor e humidade permanente</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
 <span>Conta de água disparada</span>
 </li>
 </ul>
 </div>
 ...
 <span>Casa inabitável</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5" />
 <span>Risco de refluxo e inundação</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5" />
 <span>Problema agrava com cada uso</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5" />
 ...
 <span>Danos em móveis e equipamentos</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-red-700 flex-shrink-0 mt-0.5" />
 <span>Infiltração em andares inferiores</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-red-700 flex-shrink-0 mt-0.5" />
 <span>Risco elétrico (curto-circuito)</span>
 </li>
 <li className="flex items-start gap-2">
 <AlertTriangle className="w-5 h-5 text-red-700 flex-shrink-0 mt-0.5" />
 ...
 Ridgid K-9102 (€8.000), câmara endoscópica (€2.000), FLIR (€12.000)
 </p>
 <div className="space-y-2">
 <p className="flex items-center gap-2 text-gray-700">
 <span className="text-green-500 font-bold">✓</span>
 Não precisamos "ir buscar material"
 </p>
 <p className="flex items-center gap-2 text-gray-700">
 <span className="text-green-500 font-bold">✓</span>
 Resolvemos no local, na hora
 </p>
 <p className="flex items-center gap-2 text-gray-700">
 <span className="text-green-500 font-bold">✓</span>
...
<span className="text-green-500 font-bold">✓</span>
 ...
 <p className="text-gray-700 mb-4">
 Equipamento profissional + experiência
 </p>
 <div className="space-y-2">
 <p className="flex items-center gap-2 text-gray-700">
 <span className="text-green-500 font-bold">✓</span>
 ...
 <p className="flex items-center gap-2 text-gray-700">
 <span className="text-green-500 font-bold">✓</span>
 Não voltamos 3 vezes "para ver melhor"
 </p>
 <p className="flex items-center gap-2 text-gray-700">
 <span className="text-green-500 font-bold">✓</span>
 Problema RESOLVIDO, não remendado
 </p>
 </div>
 </div>
 </div>
 ...
 <p className="text-gray-700 mb-4">
 3 meses mão de obra por escrito
 </p>
 <div className="space-y-2">
 <p className="flex items-center gap-2 text-gray-700">
 <span className="text-green-500 font-bold">✓</span>
 ...
 <div className="flex justify-between text-xl font-black text-cyan-600">
 <span>TOTAL:</span>
 <span>187,50€</span>
 </div>
 </div>
 <p className="text-sm text-gray-600 mt-4 italic text-center">
 Vale a pena? Casa sem inundação = SIM
 </p>
 </div>
 </div>
 </div>
