  ...
  return (
    <>
      ...
      <EmotionalHero
        ...
        urgencyText="Técnico disponível AGORA • Chegamos em 15 minutos"
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-black mb-4">
            Não Espere Mais. Cada Minuto Conta.
          </h2>
          <p className="text-xl md:text-2xl mb-8 font-semibold">
            Técnico disponível AGORA. Chegamos em 15 minutos. Paramos a fuga.
          </p>
