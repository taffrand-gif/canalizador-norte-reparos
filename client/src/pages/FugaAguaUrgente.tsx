...
export default function FugaAguaUrgente() {
 useEffect(() => {
 document.title = "Fuga de Água Urgente? Paramos Atendimento mediante confirmação | Norte Reparos";
 ...
 meta.setAttribute('content', 'Fuga de água em casa? Técnico a caminho Atendimento mediante confirmação. Paramos a fuga, evitamos danos maiores. Atendimento 24h/7d. Ligue +351 928 484 451.');
 }, []);
 const faqSchema = {
