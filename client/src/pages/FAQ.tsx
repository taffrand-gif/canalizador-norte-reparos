...
export default function FAQPage() {
 ...
 answer: "Atendemos num raio de 130km a partir de Trás-os-Montes. Para localidades mais distantes, aplicamos uma taxa de deslocação adicional (consultar). Cobrimos praticamente todo o Nordeste Transmontano."
 },
 {
