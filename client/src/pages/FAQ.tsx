...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Ao primeiro sinal: entupimentos, fugas visíveis, água quente que não funciona, cheiros desagradáveis, humidades. Não espere que piore - problemas pequenos tornam-se caros se não tratados atempadamente."
    },
    {
