...
export default function SinaisFugasAgua() {
  ...
  const sinais = [
    ...
    },
    {
      ...
      urgencia: "critica",
      acao: "Teste simples: feche tudo, espere 30 min, verifique contador."
    },
    {
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <ol className="space-y-4">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div><strong>Espere 30 minutos</strong> sem usar água nenhuma</div>
                </li>
                <li className="flex items-start gap-4">
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="container text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/351928484451?text=Olá,%20suspeito%20de%20uma%20fuga%20de%20água.%20Podem%20ajudar?" className="inline-flex items-center justify-center gap-2 bg-green-500 text-white px-8 py-4 rounded-lg text-xl font-bold hover:bg-green-600 transition-all shadow-lg">
                💬 WhatsApp
              </a>
            </div>
          </div>
