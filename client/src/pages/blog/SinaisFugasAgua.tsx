...
export default function SinaisFugasAgua() {
 ...
 { "@type": "Question", "name": "O que fazer se ouvir água a correr com todas as torneiras fechadas?", "acceptedAnswer": { "@type": "Answer", "text": "É urgente — indica fuga ativa. Feche a torneira geral mediante confirmação e chame um canalizador profissional. Temos equipamento de deteção térmica para encontrar a fuga sem partir paredes." } },
 { "@type": "Question", "name": "O contador de água a rodar sozinho indica fuga?", "acceptedAnswer": { "@type": "Answer", "text": "Sim. Se fechar todas as torneiras e o contador continuar a rodar, existe uma fuga ativa na instalação. Ligue mediante confirmação para um canalizador — quanto mais tarde, maior o dano e o desperdício." } },
 ...
 urgencia: "critica",
 acao: "Teste simples: feche tudo, A confirmar, verifique contador."
 },
 {
 ...
 <div><strong> A confirmar</strong> sem usar água nenhuma</div>
 </li>
 <li className="flex items-start gap-4">
