...
- **Danos em pavimentos e paredes:** Água infiltrada destrói materiais
- **Aumento da fatura de água:** Uma fuga de 1 gota/segundo = 8.640 litros/mês
- **Risco de curtos-circuitos:** Água e eletricidade são combinação perigosa
- **Desenvolvimento de bolor:** Problemas de saúde respiratória

### Consequências a Longo Prazo
- **Estrutura comprometida:** Vigas e pilares podem apodrecer
- **Desvalorização do imóvel:** Humidade visível reduz valor em 20-30%
- **Problemas com seguros:** Muitas apólices não cobrem danos por falta de manutenção
- **Conflitos em condomínios:** Fugam podem afetar vizinhos

## Tipos de Fugam de Água e Suas Características

### 1. Fugam Visíveis
**Localização:** Torneiras, válvulas, conexões visíveis
**Sintomas:** Gotejamento constante, poças de água, corrosão visível
**Complexidade:** Baixa a média
**Técnica Recomendada:** Substituição direta do componente

### 2. Fugam em Canalizações Aparentes
...
**Sintomas:** Pressão baixa no sistema, necessidade de reposição frequente de água
...
**Precisão:** ±5cm de profundidade
**Custo:** €150-€300
**Indicação:** Fugam ocultas em pavimentos e paredes
**Vantagem:** Zero destruição, localização exata

### Método 2: Câmara Termográfica por Infravermelhos
**Tecnologia:** Deteção de diferenças de temperatura
**Precisão:** Identifica área aproximada
**Custo:** €80-€180
**Indicação:** Fugam em sistemas de água quente
**Vantagem:** Rápido e não invasivo

### Método 3: Gás Traçador (Hélio ou Hidrogénio)
**Tecnologia:** Injeção de gás no sistema + detetor
**Precisão:** Extremamente alta
**Custo:** €200-€400
**Indicação:** Sistemas de aquecimento, fugam mínimas
**Vantagem:** Deteta fugam invisíveis a olho nu

### Método 4: Endoscopia por Câmara Miniaturizada
**Tecnologia:** Câmara de 5-10mm de diâmetro
**Precisão:** Visual direto do problema
**Custo:** €100-€250
...
| **Fuga oculta (localização)** | €150-€300 | €250-€500 | €600-€1.200 | 24 meses |
...
2. **Escolha do método** de localização mais adequado
3. **Execução do diagnóstico** com equipamento especializado
...
### Sistemas de Junção
- **Press fitting:** Conexão por pressão, rápida e segura
- **Soldadura por capilaridade:** Para cobre, extremamente durável
- **Fusão térmica:** Para PP-R, junção homogénea
...
1. **Inspeção visual** de todas as torneiras e válvulas
2. **Verificação de pressão** no sistema (ideal: 3-4 bar)
3. **Teste de drenagem** em sifões e ralos
4. **Inspeção por câmara** de canalizações principais

### Antes do Inverno (Especial em Trás-os-Montes)
1. **Proteção anti-congelamento** de tubos exteriores
2. **Drenagem** de sistemas não utilizados
3. **Isolamento térmico** de tubos em áreas frias
4. **Verificação** de sistemas de aquecimento

### Sinais de Alerta a Monitorizar
- **Aumento inexplicado** da fatura de água
- **Manchas de humidade** que aparecem sem chuva
...
- [ERSAR - Estatísticas de Perdas de Água](https://www.ersar.pt)
- [LNEC - Técnicas de Deteção de Fugam](https://www.lnec.pt)
- [Normas para Sistemas de Abastecimento de Água](https://www.ipq.pt)
