...
export default function PouparAguaCasa() {
  useEffect(() => {
    ...
    canonical.setAttribute('href', 'https://norte-reparos.com/blog/poupar-agua-casa-dicas-praticas');
  ...
  const dicas = [
    ...
    },
    {
      ...
      custo: "€0",
      descricao: "Banho de imersão: 150-200L. Duche de 5 minutos: 50-60L. Reduza tempo de duche para 5 minutos.",
    ...
    },
    {
      ...
      poupanca: "3.000L/mês",
      custo: "€0",
      descricao: "Máquina de lavar roupa gasta 40-60L por ciclo. Espere ter carga completa antes de lavar.",
      dificuldade: "Fácil (mudança de hábito)"
    },
    {
      numero: 7,
      ...
      custo: "€0",
      descricao: "Torneira aberta 2 minutos = 24L desperdiçados. Use copo para enxaguar.",
      dificuldade: "Fácil (mudança de hábito)"
    },
    {
      numero: 8,
    ...
    },
    {
      ...
      custo: "€0",
      descricao: "Mangueira aberta 20 minutos = 400L. Balde + esponja = 100L. Ou use lavagem automática (recicla água).",
      dificuldade: "Fácil (mudança de hábito)"
    },
    {
      numero: 10,
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="container text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/351928484451?text=Olá,%20quero%20instalar%20equipamentos%20para%20poupar%20água." className="inline-flex items-center justify-center gap-2 bg-green-500 text-white px-8 py-4 rounded-lg text-xl font-bold hover:bg-green-600 transition-all shadow-lg">
                💬 WhatsApp
              </a>
            </div>
          </div>
