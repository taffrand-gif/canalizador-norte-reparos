...
export default function InstalacaoTomadasSeguranca() {
 ...
 <link rel="canonical" href="https://canalizador-norte-reparos.pt/blog/instalacao-tomadas-seguranca" />
 ...
 <a href="tel:+351928484451" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition flex items-center gap-2">
 ...
 * Preços válidos para Bragança e Trás-os-Montes em 2026. Incluem IVA.
 ...
 <p className="text-gray-700 mb-0">
 Tomada em circuito existente: 30-resposta prioritária. Tomada com circuito novo: 1-2 horas.
 ...
 <a href="tel:+351928484451" className="bg-white text-blue-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-50 transition flex items-center justify-center gap-2">
 <Phone className="w-6 h-6" />
 Ligar: 928 484 451
 </a>
 <a href="https://wa.me/351928484451?text=Olá!%20Preciso%20de%20orçamento%20para%20instalação%20de%20tomadas." className="bg-green-500 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-green-600 transition flex items-center justify-center gap-2">
