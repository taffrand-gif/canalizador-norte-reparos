        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section id="sinais" className="mb-12">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-6">
              ...
              <p className="text-blue-700">Feche todas as torneiras e aparelhos que usam água. Anote o valor do contador. Espere 2 horas sem usar água. Se o contador avançou, tem uma fuga.</p>
            </div>
          </section>
