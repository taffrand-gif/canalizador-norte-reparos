...
const EvitarFugasAguaPrevencao: React.FC = () => {
 ...
 <strong>Técnico Mendes</strong> é canalizador com vasta experiência em Trás-os-Montes. Especialista em deteção e arranjo de fugas de água, já resolveu centenas de casos na região, incluindo situações de emergência no inverno.
 </p>
