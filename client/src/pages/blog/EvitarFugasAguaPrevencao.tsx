...
const EvitarFugasAguaPrevencao: React.FC = () => {
 ...
 <strong>Técnico Mendes</strong> é canalizador com 12 anos de experiência em Trás-os-Montes. Especialista em deteção e arranjo de fugas de água, já resolveu mais de 800 casos na região, incluindo situações de emergência no inverno.
 </p>
