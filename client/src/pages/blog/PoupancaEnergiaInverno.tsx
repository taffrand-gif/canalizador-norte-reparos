...
export default function PoupancaEnergiaInverno() {
 ...
 canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/blog/poupanca-energia-inverno-tras-os-montes');
 ...
 descricao: "Programe o aquecimento para ligar A confirmar antes de acordar e desligar quando sai. Temperatura ideal: 19-21°C.",
 ...
 <a href="https://wa.me/351928484451?text=Olá,%20quero%20reduzir%20a%20conta%20de%20luz%20no%20inverno." className="inline-flex items-center justify-center gap-2 bg-green-700 text-white px-8 py-4 rounded-lg text-xl font-bold hover:bg-green-800 transition-all shadow-lg">
 💬 WhatsApp
 </a>
 </div>
 </div>
