 ...
 * Valores incluem material e instalação. Orçamento personalizado gratuito.
 ...
 <a href="https://wa.me/351928484451?text=Olá,%20quero%20um%20orçamento%20para%20iluminação%20exterior." className="inline-flex items-center justify-center gap-2 bg-green-700 text-white px-8 py-4 rounded-lg text-xl font-bold hover:bg-green-800 transition-all shadow-lg">
 💬 WhatsApp
 </a>
 </div>
 </div>
