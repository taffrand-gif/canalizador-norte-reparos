...
export default function AutomacaoResidencialGuia() {
 ...
 canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/blog/automacao-residencial-casa-inteligente');
 ...
 * Valores incluem equipamento e instalação. Orçamento personalizado sem compromisso.
 ...
 <a href="https://wa.me/351928484451?text=Olá,%20quero%20saber%20mais%20sobre%20automação%20residencial." className="inline-flex items-center justify-center gap-2 bg-green-700 text-white px-8 py-4 rounded-lg text-xl font-bold hover:bg-green-800 transition-all shadow-lg">
 💬 WhatsApp
 </a>
 </div>
 </div>
