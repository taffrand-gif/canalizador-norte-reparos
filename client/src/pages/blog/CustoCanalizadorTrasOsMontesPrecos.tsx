              ...
              <table className="min-w-full bg-white border border-gray-300 rounded-xl">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-200 hover:bg-blue-50">
                    ...
                    <td className="py-4 px-6">45-90 min</td>
                  </tr>
                  <tr className="border-b border-gray-200 hover:bg-blue-50">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="md:w-3/4">
              ...
              <p className="text-gray-700 mb-4">
                ...
                na região de Trás-os-Montes. Já analisou mais de 1.500 orçamentos e ajudou centenas de clientes a obter 
