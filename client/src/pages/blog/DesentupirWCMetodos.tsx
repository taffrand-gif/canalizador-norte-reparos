...
export default function DesentupirWCMetodos() {
 ...
 { "@type": "Question", "name": "Quanto custa um canalizador para desentupir o WC?", "acceptedAnswer": { "@type": "Answer", "text": "Um canalizador profissional custa entre 60€ e 100€ para desentupir o WC, incluindo diagnóstico da causa raiz e garantia no trabalho. A deslocação tem preço único em qualquer localidade servida: 30 € em dias úteis (9h–17h) e 50 € à noite, fins de semana e feriados." } }
 ]
 });
 ...
 como: "Deite 1L de água quente (não fervente) com detergente da loiça. A confirmar.",
 eficacia: "60%",
 ...
 como: "1 chávena de bicarbonato + 1 chávena de vinagre. A confirmar, depois água quente.",
 eficacia: "50%",
