  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Teste simples: feche todas as torneiras e aparelhos que usem água. Anote o número do contador. Espere 30 minutos sem usar água. Se o contador mudou, tem uma fuga ativa."
        }
      },
      {
        "@type": "Question",
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg mb-12">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              anote o contador, espere 30 min. Se mudou, tem fuga. Em Bragança, detetamos fugas com câmara térmica por 80-150€.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl p-8">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                {[
                  ...
                  { num: 3, texto: "Espere 30 minutos sem usar água nenhuma" },
