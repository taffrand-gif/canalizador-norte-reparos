...
export default function EsquentadorAvariadoArranjarSubstituir() {
 ...
 {[
 { avaria: "Trocar pilhas", custo: "5-10€", tempo: "alguns minutos" },
 { avaria: "Limpar queimador", custo: "50-70€", tempo: "30-alguns minutos" },
 { avaria: "Trocar termóstato", custo: "60-90€", tempo: "45-alguns minutos" },
