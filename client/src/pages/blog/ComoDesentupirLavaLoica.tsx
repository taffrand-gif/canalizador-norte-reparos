...
const ComoDesentupirLavaLoica: React.FC = () => {
 ...
 <p className="text-gray-600">Tape o ralo e deixe a mistura atuar por A confirmar a 1 hora.</p>
 </div>
 </li>
 <li className="flex items-start gap-3">
 <span className="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0">4</span>
 ...
 <strong>Técnico Mendes</strong> é canalizador com vasta experiência em Trás-os-Montes. 
 Especialista em desentupimentos e arranjos de emergência, já resolveu centenas de casos na região. 
