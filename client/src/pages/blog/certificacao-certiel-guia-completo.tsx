...
export default function CertificacaoCertielGuiaCompleto() {
 ...
 {
 "@type": "Question",
 "name": "O que é a certificação elétrica?",
 "acceptedAnswer": {
 "@type": "Answer",
 "text": " é o certificado de conformidade da instalação elétrica emitido por entidade certificadora acreditada. Atesta que a instalação cumpre as normas de segurança portuguesas (RTIEBT). Obrigatório para ligação à rede elétrica."
 }
 },
 {
 "@type": "Question",
 "name": "Quando é obrigatória a certificação elétrica?",
 "acceptedAnswer": {
 "@type": "Answer",
 ...
 {
 "@type": "Question",
 "name": "Quanto custa a certificação elétrica em Bragança?",
 "acceptedAnswer": {
 "@type": "Answer",
 ...
 {
 "@type": "Question",
 "name": "Quanto tempo demora a obter ?",
 "acceptedAnswer": {
 "@type": "Answer",
 ...
 {
 "@type": "Question",
 "name": "O que acontece se não tiver ?",
 "acceptedAnswer": {
 "@type": "Answer",
 ...
 <p>
 é o <strong>Certificado de Execução de Instalações Elétricas</strong>, um documento oficial que atesta que a instalação elétrica do seu imóvel cumpre todas as normas de segurança portuguesas (RTIEBT - Regras Técnicas das Instalações Elétricas de Baixa Tensão).
 </p>
 <p>
 ...
 * Preços incluem: inspeção, testes de conformidade, correções menores, emissão e registo do certificado. Correções maiores orçamentadas à parte.
 ...
 <li><strong> anterior:</strong> Se existir (para renovação)</li>
 </ul>
 <p>
 ...
 <p>
 Operar sem certificação elétrica válida tem consequências graves:
 </p>
 <ul>
 <li><strong>Não pode ligar eletricidade:</strong> EDP/Endesa recusam ligação sem certificado válido</li>
 <li><strong>Venda/arrendamento bloqueados:</strong> Notários e bancos exigem para escrituras</li>
 ...
 <p>
 Muitas pessoas confundem com inspeção periódica. São coisas diferentes:
 </p>
