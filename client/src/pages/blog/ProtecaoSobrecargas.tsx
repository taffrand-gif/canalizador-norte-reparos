...
export default function ProtecaoSobrecargas() {
 ...
 canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/blog/protecao-sobrecargas-eletricas-casa');
 ...
 faqScript.id = 'schema-faq-protecao-sobrecargas';
 faqScript.text = JSON.stringify({
 "@context": "https://schema.org",
 "@type": "FAQPage",
 "mainEntity": [
 { "@type": "Question", "name": "O que é uma sobrecarga elétrica?", "acceptedAnswer": { "@type": "Answer", "text": "Uma sobrecarga ocorre quando a corrente num circuito excede a capacidade dos fios. Por exemplo: aquecedor (2.000W) + micro-ondas (1.200W) num circuito de 10A (2.300W) = 3.200W de sobrecarga, causando aquecimento dos fios e risco de incêndio." } },
 ...
 const faqEl = document.getElementById('schema-faq-protecao-sobrecargas');
 ...
 <a href="https://wa.me/351928484451?text=Olá,%20quero%20proteger%20a%20minha%20casa%20contra%20sobrecargas." className="inline-flex items-center justify-center gap-2 bg-green-700 text-white px-8 py-4 rounded-lg text-xl font-bold hover:bg-green-800 transition-all shadow-lg">
 💬 WhatsApp
 </a>
 </div>
 </div>
