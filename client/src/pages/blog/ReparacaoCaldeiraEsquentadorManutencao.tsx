      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mt-12 p-8 bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/${ACTIVE_CONFIG.whatsappNumber}`} className="bg-green-500 hover:bg-green-600 text-white font-bold px-8 py-3 rounded-lg transition-colors">💬 WhatsApp</a>
          </div>
        </section>
