...
export default function Cerva() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Cerva — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Cerva?', answer: 'Atendimento 24h/7d em Cerva e arredores. Ligue 928 484 451.' },
