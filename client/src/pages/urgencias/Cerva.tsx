...
export default function Cerva() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Cerva — Atendimento 24h | Orçamento Grátis";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Cerva (Vila Real). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-cerva');
    ...
    schema.text = JSON.stringify({
      ...
      "areaServed": [
        { "@type": "City", "name": "Cerva" },
        { "@type": "AdministrativeArea", "name": "Vila Real" }
      ],
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Cerva?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Cerva e arredores. Ligue 928 484 451.' },
    { question: 'Quanto custa uma urgência em Cerva?', answer: 'O preço é combinado antes da intervenção. Sem surpresas. Fatura com NIF incluída.' },
    { question: 'Trabalham aos fins de semana em Cerva?', answer: 'Sim, atendimento 24 horas, 7 dias por semana, incluindo feriados.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Cerva?', answer: 'Sim, servimos Cerva e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Cerva', href: '/canalizador-urgente-cerva' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Cerva</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Cerva (Vila Real). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Cerva`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Cerva</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Cerva?</h2>
