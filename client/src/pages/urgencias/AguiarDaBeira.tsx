// SEO: canalizador urgente Aguiar da Beira
...
export default function AguiarDaBeira() {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Aguiar da Beira (Guarda). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-aguiar-da-beira');
    ...
    schema.text = JSON.stringify({
      ...
      "areaServed": [
        { "@type": "City", "name": "Aguiar Da Beira" },
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Aguiar Da Beira?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Aguiar Da Beira e arredores. Ligue 928 484 451.' },
    { question: 'Quanto custa uma urgência em Aguiar Da Beira?', answer: 'O preço é combinado antes da intervenção. Sem surpresas. Fatura com NIF incluída.' },
    { question: 'Trabalham aos fins de semana em Aguiar Da Beira?', answer: 'Sim, atendimento 24 horas, 7 dias por semana, incluindo feriados.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Aguiar Da Beira?', answer: 'Sim, servimos Aguiar Da Beira e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Aguiar Da Beira', href: '/canalizador-urgente-aguiar-da-beira' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Aguiar da Beira</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Aguiar Da Beira (Guarda). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Aguiar Da Beira`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Aguiar Da Beira</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Aguiar Da Beira?</h2>
