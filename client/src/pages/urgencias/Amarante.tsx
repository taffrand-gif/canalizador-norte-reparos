...
export default function Amarante() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Amarante — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Amarante?', answer: 'Atendimento 24h/7d em Amarante e arredores. Ligue 928 484 451.' },
