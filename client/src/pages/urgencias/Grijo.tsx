...
export default function Grijo() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Grijó — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Grijo?', answer: 'Atendimento 24h/7d em Grijo e arredores. Ligue 928 484 451.' },
