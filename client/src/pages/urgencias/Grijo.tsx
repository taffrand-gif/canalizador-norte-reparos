...
export default function Grijo() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Grijó — Atendimento 24h | Orçamento Grátis";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Grijó (Bragança). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-grijo');
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Grijo?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Grijo e arredores. Ligue 928 484 451.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Grijo?', answer: 'Sim, servimos Grijo e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Grijo', href: '/canalizador-urgente-grijo' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Grijó</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Grijo (Bragança). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Grijo`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Grijo</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Grijo?</h2>
