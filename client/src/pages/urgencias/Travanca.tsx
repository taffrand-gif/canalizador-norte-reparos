...
export default function Travanca() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Travanca — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Travanca?', answer: 'Atendimento 24h/7d em Travanca e arredores. Ligue 928 484 451.' },
