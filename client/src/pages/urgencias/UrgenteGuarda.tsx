// SEO: canalizador urgente distrito de Guarda
...
export default function UrgenteGuarda() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Distrito de Guarda — 24h";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em todo o distrito de Guarda. 24h/7d.");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-distrito-de-guarda');
  ...
  return (
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Trás-os-Montes', href: '/canalizador-urgente-distrito-de-guarda' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente no Distrito de Guarda</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Trás-os-Montes (Guarda). Orçamento sem compromisso.
              </p>
