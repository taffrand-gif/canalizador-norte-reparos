...
export default function Lixa() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Lixa — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Lixa?', answer: 'Atendimento 24h/7d em Lixa e arredores. Ligue 928 484 451.' },
