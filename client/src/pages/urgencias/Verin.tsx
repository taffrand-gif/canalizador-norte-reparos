...
export default function Verin() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Verín — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Verin?', answer: 'Atendimento 24h/7d em Verin e arredores. Ligue 928 484 451.' },
