...
export default function Verin() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Verín — Atendimento 24h | Orçamento Grátis";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Verín (Bragança). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-verin');
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Verin?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Verin e arredores. Ligue 928 484 451.' },
    { question: 'Quanto custa uma urgência em Verin?', answer: 'O preço é combinado antes da intervenção. Sem surpresas. Fatura com NIF incluída.' },
    { question: 'Trabalham aos fins de semana em Verin?', answer: 'Sim, atendimento 24 horas, 7 dias por semana, incluindo feriados.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Verin?', answer: 'Sim, servimos Verin e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Verin', href: '/canalizador-urgente-verin' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Verín</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Verin (Bragança). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Verin`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Verin</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Verin?</h2>
