...
export default function Resende() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Resende — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Resende?', answer: 'Atendimento 24h/7d em Resende e arredores. Ligue 928 484 451.' },
