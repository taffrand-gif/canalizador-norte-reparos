// SEO: canalizador urgente Resende
...
export default function Resende() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Resende — Atendimento 24h | Orçamento Grátis";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Resende (Viseu). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-resende');
    ...
    schema.text = JSON.stringify({
      ...
      "areaServed": [
        ...
        { "@type": "AdministrativeArea", "name": "Viseu" }
      ],
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Resende?', answer: 'Atendimento mediante confirmação 24h/7d em Resende e arredores. Ligue 928 484 451.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Resende?', answer: 'Sim, servimos Resende e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Resende', href: '/canalizador-urgente-resende' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Resende</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Resende (Viseu). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Resende`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Resende</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Resende?</h2>
