...
export default function CeloricoDaBeira() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Celorico da Beira — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Celorico Da Beira?', answer: 'Atendimento 24h/7d em Celorico Da Beira e arredores. Ligue 928 484 451.' },
