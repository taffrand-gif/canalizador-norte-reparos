...
export default function CeloricoDaBeira() {
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Celorico Da Beira?', answer: 'Atendimento mediante confirmação 24h/7d em Celorico Da Beira e arredores. Ligue 928 484 451.' },
