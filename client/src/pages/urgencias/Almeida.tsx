// SEO: canalizador urgente Almeida
...
export default function Almeida() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Almeida — Atendimento 24h | Orçamento Grátis";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Almeida (Guarda). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-almeida');
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Almeida?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Almeida e arredores. Ligue 928 484 451.' },
    { question: 'Quanto custa uma urgência em Almeida?', answer: 'O preço é combinado antes da intervenção. Sem surpresas. Fatura com NIF incluída.' },
    { question: 'Trabalham aos fins de semana em Almeida?', answer: 'Sim, atendimento 24 horas, 7 dias por semana, incluindo feriados.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Almeida?', answer: 'Sim, servimos Almeida e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Almeida', href: '/canalizador-urgente-almeida' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Almeida</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Almeida (Guarda). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Almeida`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Almeida</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Almeida?</h2>
