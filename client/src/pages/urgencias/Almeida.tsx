...
export default function Almeida() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Almeida — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Almeida?', answer: 'Atendimento 24h/7d em Almeida e arredores. Ligue 928 484 451.' },
