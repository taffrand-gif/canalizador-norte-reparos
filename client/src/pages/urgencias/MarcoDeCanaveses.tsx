...
export default function MarcoDeCanaveses() {
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Marco De Canaveses?', answer: 'Atendimento mediante confirmação 24h/7d em Marco De Canaveses e arredores. Ligue 928 484 451.' },
