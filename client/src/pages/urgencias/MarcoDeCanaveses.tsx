// SEO: canalizador urgente Marco de Canaveses
...
export default function MarcoDeCanaveses() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Marco de Canaveses — Atendimento 24h | Orçamento Grátis";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Marco de Canaveses (Porto). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-marco-de-canaveses');
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Marco De Canaveses?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Marco De Canaveses e arredores. Ligue 928 484 451.' },
    { question: 'Quanto custa uma urgência em Marco De Canaveses?', answer: 'O preço é combinado antes da intervenção. Sem surpresas. Fatura com NIF incluída.' },
    { question: 'Trabalham aos fins de semana em Marco De Canaveses?', answer: 'Sim, atendimento 24 horas, 7 dias por semana, incluindo feriados.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Marco De Canaveses?', answer: 'Sim, servimos Marco De Canaveses e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Marco De Canaveses', href: '/canalizador-urgente-marco-de-canaveses' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Marco de Canaveses</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Marco De Canaveses (Porto). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Marco De Canaveses`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Marco De Canaveses</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Marco De Canaveses?</h2>
