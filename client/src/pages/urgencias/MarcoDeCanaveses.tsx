...
export default function MarcoDeCanaveses() {
  ...
  useEffect(() => {
    document.title = "💧 Canalizador Urgente Marco de Canaveses — Atendimento 24h | estimativa sem custo";
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Marco De Canaveses?', answer: 'Atendimento 24h/7d em Marco De Canaveses e arredores. Ligue 928 484 451.' },
