// SEO: canalizador urgente distrito de Viseu
...
export default function UrgenteViseu() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Distrito de Viseu — 24h";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em todo o distrito de Viseu. 24h/7d.");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-distrito-de-viseu');
  ...
  return (
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Trás-os-Montes', href: '/canalizador-urgente-distrito-de-viseu' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente no Distrito de Viseu</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Trás-os-Montes (Viseu). Orçamento sem compromisso.
              </p>
