// SEO: canalizador urgente distrito de Vila Real
...
export default function UrgenteVilaReal() {
  const { config } = useSite();

  useEffect(() => {
    document.title = "💧 Canalizador Urgente Distrito de Vila Real — 24h";
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em todo o distrito de Vila Real. 24h/7d.");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-distrito-de-vila-real');
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Trás-os-Montes?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Trás-os-Montes e arredores. Ligue 928 484 451.' },
  ...
  return (
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Trás-os-Montes', href: '/canalizador-urgente-distrito-de-vila-real' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente no Distrito de Vila Real</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Trás-os-Montes (Vila Real). Orçamento sem compromisso.
              </p>
