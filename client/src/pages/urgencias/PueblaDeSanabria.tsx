...
export default function PueblaDeSanabria() {
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Puebla De Sanabria?', answer: 'Atendimento mediante confirmação 24h/7d em Puebla De Sanabria e arredores. Ligue 928 484 451.' },
