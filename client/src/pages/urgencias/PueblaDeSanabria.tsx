// SEO: canalizador urgente Puebla de Sanabria
...
export default function PueblaDeSanabria() {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', "Canalizador urgente em Puebla de Sanabria (Bragança). Atendimento 24h/7d, orçamento sem compromisso. Ligue: 928 484 451");
    ...
    canonical.setAttribute('href', 'https://canalizador-norte-reparos.pt/canalizador-urgente-puebla-de-sanabria');
    ...
    schema.text = JSON.stringify({
      ...
      "areaServed": [
        { "@type": "City", "name": "Puebla De Sanabria" },
        { "@type": "AdministrativeArea", "name": "Bragança" }
      ],
  ...
  const faqs = [
    { question: 'Qual o prazo de chegada em Puebla De Sanabria?', answer: 'Atendimento mediante confirmação por telefone 24h/7d em Puebla De Sanabria e arredores. Ligue 928 484 451.' },
    { question: 'Quanto custa uma urgência em Puebla De Sanabria?', answer: 'O preço é combinado antes da intervenção. Sem surpresas. Fatura com NIF incluída.' },
    { question: 'Trabalham aos fins de semana em Puebla De Sanabria?', answer: 'Sim, atendimento 24 horas, 7 dias por semana, incluindo feriados.' },
    ...
    { question: 'Cobrem freguesias vizinhas de Puebla De Sanabria?', answer: 'Sim, servimos Puebla De Sanabria e todas as freguesias e aldeias do concelho.' }
  ];
  return (
    <>
    ...
    <Breadcrumbs items={[
      ...
      { label: 'Puebla De Sanabria', href: '/canalizador-urgente-puebla-de-sanabria' }
    ]} />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Canalizador Urgente em Puebla de Sanabria</h1>
              <p className="text-xl mb-8">
                Atendimento 24h/7d em Puebla De Sanabria (Bragança). Orçamento sem compromisso.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${config.whatsapp}?text=Olá, preciso de um canalizador urgente em Puebla De Sanabria`}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center">Urgências Cobertas em Puebla De Sanabria</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-700 text-white text-center">
          <h2 className="text-3xl font-bold mb-6">Urgência em Puebla De Sanabria?</h2>
