...
document.title = "Esquentador Avariado? Água Quente | Norte Reparos"
 ...
 description: 'Diagnóstico e orçamento por escrito antes da intervençãoos. Só paga se aprovar e arranjarmos.'
 },
 {
 icon: 'clock',
 ...
 * Preços incluem deslocação, mão de obra e IVA. Peças à parte quando necessário.
 ...
 ✓ estimativa sem custo • ✓ Arranjo no Dia • ✓ Garantia 12 Meses
 </p>
 </div>
 </section>
 <Footer />
