...
export default function Servicos() {
 ...
 metaDescription.setAttribute('content', 'Serviços completos de canalizador em Trás-os-Montes: desentupimentos, arranjo de fugas, instalação sanitários, aquecimento central. profissionais qualificados, sem compromisso, urgências 24h.');
 }, [config]);
 ...
 profissionais qualificados, equipamento moderno e garantia no serviço.
 </p>
