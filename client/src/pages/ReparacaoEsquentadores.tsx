...
const faqItems = [
  ...
  { question: "Quando devo substituir o esquentador em vez de reparar?", answer: "Se o esquentador tem mais de 15 anos, as reparações são frequentes ou as peças já não existem, é mais económico substituir. Um esquentador novo é mais eficiente e seguro." },
  { question: "Reparam todas as marcas de caldeiras?", answer: "Sim, reparamos caldeiras e esquentadores de todas as marcas: Vaillant, Junkers/Bosch, Vulcano, Ariston, Baxi, Roca e outras. Temos peças originais em stock." }
];

export default function ReparacaoEsquentadores() {
  useEffect(() => {
    document.title = "Reparação de Esquentadores e Caldeiras em Trás-os-Montes | Manutenção 24h";
    let meta = document.querySelector('meta[name="description"]');
    if (!meta) { meta = document.createElement('meta'); meta.setAttribute('name', 'description'); document.head.appendChild(meta); }
    meta.setAttribute('content', 'Reparação de esquentadores e caldeiras em Trás-os-Montes. Manutenção, substituição, todas as marcas. Urgências 24h. Ligue +351 928 484 451.');
  }, []);

  const serviceSchema = {
    "@context": "https://schema.org", "@type": "Service",
    "name": "Reparação de Esquentadores e Caldeiras", "provider": { "@type": "Plumber", "name": "Norte Reparos", "telephone": ACTIVE_CONFIG.phone },
    "areaServed": { "@type": "GeoCircle", "geoMidpoint": { "@type": "GeoCoordinates", "latitude": 41.4393, "longitude": -6.9603 }, "geoRadius": "100000" },
    "description": "Reparação e manutenção profissional de esquentadores e caldeiras de todas as marcas em Trás-os-Montes."
  };
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-blue-700 to-blue-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Reparação de Esquentadores e Caldeiras</h1>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { title: "Reparação de Esquentadores", desc: "Diagnóstico e reparação de avarias: não acende, água fria, fugas de gás, ruídos estranhos. Todas as marcas.", icon: "🔥" },
              { title: "Reparação de Caldeiras", desc: "Reparação de caldeiras murais e de chão. Problemas de pressão, aquecimento, erros no display, fugas.", icon: "♨️" },
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Marcas que Reparamos</h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { service: "Reparação avaria", price: "Desde €100" },
