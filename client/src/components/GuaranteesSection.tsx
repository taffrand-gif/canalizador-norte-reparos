...
// Style Hormozi : Risk Reversal, garanties massivas, countdown
...
export default function GuaranteesSection() {
  ...
  // Calcular o tempo restante (24 horas)
  useEffect(() => {
      ...
      <div className="container">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-black mb-6">
            Garantias Que <span className="text-blue-600">Ninguém</span> Mais Oferece
          </h2>
        ...
        <div className="text-center">
          <div className="inline-block bg-blue-600 text-white px-8 py-4 rounded-2xl shadow-xl mb-6">
