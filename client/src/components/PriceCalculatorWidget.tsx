...
function PriceCalculatorWidget() {
 ...
 Preço fixo garantido. Sem surpresas. Orçamento confirmado Atendimento mediante confirmação por telefone.
 </p>
 </div>
 {/* Calculator Card */}
 <div
 ...
 *Preço final confirmado por telefone Atendimento mediante confirmação
 </p>
 </div>
 )}
 {/* CTA Buttons */}
