...
function QuoteCalculator() {
 ...
 className="fixed bottom-[152px] right-4 md:bottom-6 md:right-6 z-40 text-white font-bold px-5 py-4 rounded-full shadow-2xl transition-all hover:scale-110 flex items-center gap-A confirmar-w-[56px] min-h-[56px]"
