      ...
      <div className="container">
        ...
        <div className="pt-8 border-t-2 border-white/20 text-center text-gray-300 text-sm">
          ...
          <div className="mt-3 text-xs text-gray-500">
            Precisa de electricista? <a href="https://staff-seekers.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-300">Electricista 24h Trás-os-Montes</a>
          </div>
        </div>
      </div>
    </footer>
