    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-6 md:mt-0">
              <Link href="/">
                <a className="inline-flex items-center gap-2 bg-white text-blue-700 font-semibold px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors">
                  ← Voltar ao site
                </a>
              </Link>
            </div>
      ...
      <nav className="bg-white border-b border-gray-200 py-4">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap gap-4">
            <a href="/blog" className="px-4 py-2 bg-blue-100 text-blue-800 font-semibold rounded-lg">
              Todos os Artigos
            </a>
            <a href="/blog/dicas" className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
              Dicas Práticas
            </a>
            <a href="/blog/emergencias" className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
              Emergências
            </a>
            <a href="/blog/manutencao" className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
              Manutenção
            </a>
            <a href="/blog/instalacoes" className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
              Instalações
            </a>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Precisa de um canalizador?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a
              ...
              className="bg-white text-blue-700 font-bold text-lg px-8 py-4 rounded-xl hover:bg-blue-50 transition-colors"
            >
              📞 Ligar Agora
            </a>
            <a
