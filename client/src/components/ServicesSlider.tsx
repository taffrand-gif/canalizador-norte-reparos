...
export function ServicesSlider() {
 ...
 description: 'profissionais com equipamento profissional',
 ...
 {
 icon: '💧',
 title: 'Resposta mediante contacto Atendimento 24h/7d',
 description: 'Chegamos em média A confirmar após o seu contacto',
