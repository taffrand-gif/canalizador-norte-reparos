...
function UrgencyTimer() {
 ...
 description: 'Inspeção e diagnóstico completamente grátis',
 value: '€50 valor'},
 ];
 return (
 ...
 <a
 href={`https://wa.me/351${config.phone.replace(/\s/g, '')}?text=Olá, quero aproveitar a promoção de hoje com 15% desconto!`}
 target="_blank"
 ...
 🔥 <span className="text-yellow-300">23 pessoas</span> já aproveitaram hoje!
 </p>
 </div>
 </div>
 </div>
