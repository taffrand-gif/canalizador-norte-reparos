...
export default function CitiesGrid() {
 ...
 const servicePrefix = 'canalizador';
 return (
 <section className="py-16 bg-white">
 <div className="container">
 <div className="text-center mb-12">
 <h2 className="text-3xl md:text-4xl font-black mb-4">
 Canalizador em Trás-os-Montes
 </h2>
 ...
 className="bg-white border-2 border-gray-200 p-4 rounded-lg hover:border-cyan-600 hover:shadow-md transition-all text-center group"
 >
 <MapPin className="w-6 h-6 mx-auto mb-2 text-cyan-600 group-hover:scale-110 transition-transform" />
