...
function ContactForm() {
 ...
 window.open(`https://wa.me/351928484451?text=${msg}`, '_blank');
 };
 const handleCall = () => {
 window.location.href = 'tel:+351928484451';
 };
 return (
 ...
 Pedir Orçamento <span className="text-[#0e7490]">Grátis</span>
 </h2>
 ...
 className={`w-full rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2193b0] ${
 ...
 placeholder="Descreva brevemente o problema de canalização..."
 rows={isMobile ? 3 : 4}
 className={`w-full rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2193b0] resize-none ${
 isMobile ? 'px-5 py-4 text-lg' : 'px-4 py-3'
 }`}
 />
 </div>
 ...
 <button
 type="submit"
 className={`flex-1 flex items-center justify-center gap-2 bg-green-700 hover:bg-green-700 text-white font-bold rounded-lg transition-colors ${
 ...
 type="button"
 onClick={handleCall}
 className={`flex-1 flex items-center justify-center gap-2 bg-[#0e7490] hover:bg-[#1a7a94] text-white font-bold rounded-lg transition-colors ${
 isMobile ? 'py-5 px-6 text-xl' : 'py-4 px-6 text-lg'
 }`}
 >
