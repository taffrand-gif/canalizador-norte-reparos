...
function PriceTransparency() {
 ...
 Sem compromisso Atendimento por telefone.
 </p>
 </div>
 {/* Comparison Grid */}
 ...
 Ligue Agora — Saiba o Preço Atendimento
 </h3>
 ...
 <strong className="text-gray-900">baseado em</strong>{' '}
 clientes que apreciaram a transparência
 </p>
 </div>
 </div>
 </div>
