...
const districts: District[] = [
  {
    ...
    cities: [
      ...
      { name: 'Torre de Moncorvo', href: '/canalizador-torre-de-moncorvo' },
      { name: 'Freixo de Espada à Cinta', href: '/canalizador-freixo-de-espada-a-cinta' },
      { name: 'Alfândega da Fé', href: '/canalizador-alfandega-da-fe' },
      { name: 'Vila Flor', href: '/canalizador-vila-flor' },
      { name: 'Carrazeda de Ansiães', href: '/canalizador-carrazeda-de-ansiaes' },
      { name: 'Vimioso', href: '/canalizador-vimioso' },
    ],
  },
  {
    name: 'Distrito de Vila Real',
    cities: [
      { name: 'Vila Real', href: '/canalizador-vila-real' },
      { name: 'Chaves', href: '/canalizador-chaves' },
      { name: 'Valpaços', href: '/canalizador-valpacos' },
      { name: 'Murça', href: '/canalizador-murca' },
      { name: 'Alijó', href: '/canalizador-alijo' },
      { name: 'Sabrosa', href: '/canalizador-sabrosa' },
      { name: 'Vila Pouca de Aguiar', href: '/canalizador-vila-pouca-de-aguiar' },
      { name: 'Ribeira de Pena', href: '/canalizador-ribeira-de-pena' },
      { name: 'Mondim de Basto', href: '/canalizador-mondim-de-basto' },
      { name: 'Peso da Régua', href: '/canalizador-peso-da-regua' },
      { name: 'Santa Marta de Penaguião', href: '/canalizador-santa-marta-de-penaguiao' },
      { name: 'Mesão Frio', href: '/canalizador-mesao-frio' },
    ],
  },
  {
    name: 'Distrito de Viseu / Guarda',
    cities: [
      { name: 'Lamego', href: '/canalizador-lamego' },
      { name: 'Moimenta da Beira', href: '/canalizador-moimenta-da-beira' },
      { name: 'São João da Pesqueira', href: '/canalizador-sao-joao-da-pesqueira' },
      { name: 'Tabuaço', href: '/canalizador-tabuaco' },
      { name: 'Armamar', href: '/canalizador-armamar' },
      { name: 'Sernancelhe', href: '/canalizador-sernancelhe' },
      { name: 'Penedono', href: '/canalizador-penedono' },
...
function Header() {
  ...
  const navItems = [
    ...
    { id: 'precos', label: 'PREÇOS', action: () => (window.location.href = '/blog/custo-canalizador-tras-os-montes-precos') },
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t-2 bg-white max-h-[70vh] overflow-y-auto" style={{ borderTopColor: config.colors.primary }}>
          <nav className="container py-4 flex flex-col gap-1" role="navigation" aria-label="Menu mobile">
            ...
            <a href="/blog/custo-canalizador-tras-os-montes-precos" className="text-base font-semibold py-2 px-4 rounded-lg hover:bg-gray-100">PREÇOS</a>
