...
export default function PriceTable() {
 ...
 description: "Esquentadores, loiças sanitárias",
 price: "Sob Orçamento",
 details: ["Instalação certificada", "Verificação gás/água", "Explicação funcionamento"]}
 ];
...
<div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
    ...
    <ul className="space-y-1 text-blue-800 text-sm">
      ...
      <li className="flex justify-between"><span>Desentupimento simples (resposta prioritária):</span> <span>65€ - 130€</span></li>
