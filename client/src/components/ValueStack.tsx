...
// Style Hormozi : Montrer tout ce que o cliente recebe, âncora de preço
...
export default function ValueStack() {
  ...
  // Preços fictícios para demonstração (adaptar com preços reais)
  const valueItems = [
  ...
  const price = 80; // Preço atual da intervenção
      ...
      <div className="container max-w-4xl mx-auto">
        ...
        <div className="space-y-4 mb-8">
          {valueItems.map((item, index) => (
            <div
              key={index}
              className="flex items-center justify-between p-6 border-4 border-gray-200 rounded-2xl hover:border-blue-500 transition-all"
            >
