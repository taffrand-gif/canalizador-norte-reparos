...
// Shows confidence in quality and builds trust
...
function MoneyBackGuarantee() {
 ...
 description: 'Se não resolvermos o problema, não paga NADA.',
 badge: '100% Grátis'},
 {
 icon: '⏰',
 ...
 Estamos TÃO confiantes na qualidade do nosso trabalho que assumimos TODO o risco.
 ...
 ✅ Garantia Certificada Por Escrito
 </h3>
 <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
 Não é conversa. Recebe certificado de garantia por escrito com todas estas condições.
 ...
 <p className="text-green-800">Sabemos o que fazemos</p>
 </div>
 <div>
 <div className="text-3xl mb-2">🔧</div>
 <p className="font-bold text-green-900 mb-1">Equipamento Profissional</p>
 <p className="text-green-800">Ferramentas certas = trabalho certo</p>
 </div>
 <div>
 <div className="text-3xl mb-2">⭐</div>
 ...
 <a
 href={`https://wa.me/351${config.phone.replace(/\s/g, '')}?text=Olá, quero saber mais sobre a garantia risco zero!`}
 target="_blank"
 ...
 ✅ Sem compromisso • ✅ Orçamento grátis • ✅ Disponível 24h/7 dias
 </p>
 </div>
 </div>
 {/* Trust Indicators */}
 ...
 <p className="font-bold text-gray-900">Fatura Sempre</p>
 <p className="text-gray-600 text-sm">Trabalho legal e certificado</p>
 </div>
 <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
 <div className="text-4xl mb-2">🏆</div>
 <p className="font-bold text-gray-900"> Estrelas</p>
 <p className="text-gray-600 text-sm">500+ avaliações reais</p>
 </div>
 <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
 <div className="text-4xl mb-2">⚡</div>
 <p className="font-bold text-gray-900">Resposta {'<'}A confirmar</p>
