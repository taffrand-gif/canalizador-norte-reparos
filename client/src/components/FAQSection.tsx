            ...
            >
              <details className="group">
                <summary 
                  ...
                  itemProp="name"
                >
                  <span className="text-lg font-semibold text-gray-900 group-open:text-blue-600">
                    {faq.question}
                  </span>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-blue-600 text-white font-bold px-8 py-4 rounded-xl hover:bg-blue-700 transition-colors inline-flex items-center justify-center gap-2"
            >
              📞 Ligar Agora
            </a>
            <a
