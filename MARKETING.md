# MARKETING.md — Couche offensive (canalizador-norte-reparos)

> **Complète `AGENTS.md` (doctrine + R11 zéro invention = SUPRÊME). NE duplique RIEN.**
> NAP, phrases, équipement, règles → **lire AGENTS.md**. Ici = couche offensive de conversion. En cas de contradiction → AGENTS.md prime.

## Quadrant
**Plomberie 💧 × TRADITIONNEL** (site PRINCIPAL, pas satellite). NAP **+351 928 484 451**. Géo-neutre (Trás-os-Montes). Tâches actives = différenciation B1-B3 (cf. SEO_PLAN.md). Le satellite `canalizador-urgente.pt` couvre l'intention urgence — **ce site couvre l'intention planifiée** (ne pas dupliquer son angle).
...
- ✅ « Renovação de canalização? Orçamento por escrito detalhado — o preço combinado é o preço final. »
- ✅ « Já levou orçamentos que disparam no fim? Aqui, fala sempre com a mesma pessoa e o valor é claro à partida. »
- ✅ « Da torneira à casa de banho completa: trabalho com garantia, sem surpresas. »
- ⚠️ Garantie : ne l'écrire QUE si Filipe la tient. R145 : pas de délai chiffré inventé.

## Verbatim peurs marché (concurrents — JAMAIS cités comme avis Norte Reparos, R11)
« incumprimento de serviços » · « novo dano provocado num cano » · « Instalou uma torneira de muito má qualidade » · « Falta de envio de orçamento ».

## CTA
Tél **928 484 451** + WhatsApp + formulaire orçamento. Demande de devis = action principale (intention planifiée).
