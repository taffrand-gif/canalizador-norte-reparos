...
cat > public/sitemap-blog.xml << 'XMLEOF'
<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
<url><loc>https://canalizador-norte-reparos.pt/blog/</loc><lastmod>2026-03-09</lastmod><changefreq>weekly</changefreq><priority>0.9</priority></url>
XMLEOF

# Ajouter tous les articles blog
for file in content/blog/*.md; do
  filename=$(basename "$file" .md)
  echo "<url><loc>https://canalizador-norte-reparos.pt/blog/${filename}.html</loc><lastmod>2026-03-09</lastmod><changefreq>monthly</changefreq><priority>0.8</priority></url>" >> public/sitemap-blog.xml
done
