---
title: "Desentupimento Profissional: Guia 2026"
date: 2026-06-06
category: guia
tags: [guia, 2026, portugal]
summary: "Tudo sobre desentupimento."
author: "Norte Reparos"
reading_time: "10-12 min"
---

# Desentupimento Profissional: Guia 2026

Tudo sobre desentupimento.

## Índice

1. O que é e quando é relevante
2. Tipos e categorias
3. Custos médios em Portugal 2026
4. Como escolher profissional
5. DIY vs profissional
...
- Tem sintomas de problema (fuga, disjuntor que dispara, etc.)
- Quer comparar preços antes de contratar
- Quer saber se deve reparar ou substituir
...
Existem várias categorias a considerar antes de avançar:

**A. Por tipo de serviço**
- Reparação pontual (1-2h típico)
- Manutenção preventiva (limpezas, inspeções)
- Instalação nova
...
**Eletricista:**
- Hora de trabalho: 30-100€
- Deslocação: 15-50€
- Mão de obra diária: 250-600€

**Pacotes típicos:**
- Desentupimento: 110-180€
- Busca de fuga: 150-250€
- Reparação urgente: 110-200€
- Substituição quadro elétrico: 280-600€
- Iluminação LED (casa T3): 200-500€
- Certificação energética: 80-300€
- Certificação elétrica: 150-300€

**Custo total típico para T3 (100m²):**
...
8. **Garantia** de 1 ano mínimo nos trabalhos
9. **Equipa qualificada** (não apenas o dono)
10. **Equipamento próprio** (não aluga)
...
- "Sou certificado" mas não dá número
...
- LinkedIn
- Redes sociais
- OLX (seção profissionais)

**O que perguntar antes de contratar:**

1. Quantos anos de experiência?
2. Já fez trabalhos similares? Pode mostrar fotos?
3. Tem seguro?
4. O orçamento é final?
5. Inclui IVA?
6. Inclui certificação (se aplicável)?
7. Qual o prazo?
8. Qual a garantia?
9. Pode dar 2-3 referências de clientes?
10. Equipa própria ou subcontratada?

---

## 5. DIY vs profissional

**Quando PODE fazer sozinho (com cuidado):**

- Substituir uma lâmpada
- Desentupir sanita com ventosa (caso simples)
- Limpar filtro do AC
- Trocar vedante de torneira (se sabe o que faz)
- Pintura
- Jardinagem

**Quando DEVE chamar profissional:**

- Tudo o que envolve instalação elétrica > 230V
- Substituição de cano dentro de parede
- Instalação de esquentador a gás
- Instalação de quadro elétrico
- Certificação obrigatória
- Qualquer trabalho que exija alvará
- Situações onde o seguro não cobre DIY

**Riscos do DIY mal feito:**

- Eletricidade: incêndio, electrocução, morte
- Canalização: inundação, dano estrutural, mofo
- Gás: explosão, intoxicação
- Garantia: anulada se DIY
- Seguro: pode recusar sinistro
- Multa: até 50.000€ em casos graves

**Regra de ouro:** Se tem dúvida, chame profissional. O custo da prevenção é sempre menor que o custo da reparação.

---

## 6. Manutenção preventiva

**Checklist anual recomendado:**

**Canalização:**
- [ ] Verificar todas as torneiras (sem fugas)
- [ ] Testar autoclismos
- [ ] Verificar contador (sem fuga invisível)
- [ ] Limpar/arejadores
- [ ] Verificar sifões
- [ ] Limpar caleiras e algerozes
- [ ] Inspecionar telhado
- [ ] Verificar pressão da rede
- [ ] Limpar filtros máquina loiça

**Eletricidade:**
- [ ] Testar diferencial (botão T mensalmente)
- [ ] Verificar quadro (sem pó, sem cheiro)
- [ ] Testar disjuntores
- [ ] Verificar iluminação
- [ ] Limpar filtros AC
- [ ] Verificar tomadas e interruptores
- [ ] Testar luzes de emergência
- [ ] Verificar terra de proteção

**Custo anual de manutenção preventiva:** 200-500€
**Custo anual de reparação sem prevenção:** 500-2000€
...
**Quanto custa em média em Portugal 2026?**

Depende do serviço, zona, e urgência. Tabela detalhada na secção 3 deste guia.

**Vale a pena fazer orçamento a vários profissionais?**

SEMPRE. Recomendo 2-3 orçamentos escritos. Permite comparar e identificar preço fora do mercado.

**Posso negociar o preço?**

Sim, com inteligência. Negoceia escopo (não preço unitário), pagamento, timing.

**É melhor reparar ou substituir?**
...
Depende da dimensão. Típico: 1-3 dias para reparação, 1-3 semanas para remodelação completa.

**O que está incluído no orçamento?**

Normalmente: mão de obra, materiais, deslocação, IVA. SEMPRE peça discriminado.
...
Não. Os preços em 2026 são favoráveis. Esperar significa arriscar avaria cara.

**Como sei se estou a ser enganado?**

Preço muito abaixo do mercado, sem fatura, pressão para decidir rápido, sem referências. Sinais claros.
...
6. **Não faça DIY** em trabalho elétrico, gás, ou estrutural
7. **Confie em profissionais locais** estabelecidos

**Próximos passos recomendados:**

1. Pedir orçamentos a 2-3 profissionais
2. Verificar certificações
3. Pedir referências
4. Escolher o melhor custo-benefício (não o mais barato)
...
À noite (17h–9h), aos fins de semana e feriados: 100 €/hora e deslocação 50 €. Estimativa sem custo por telefone: **+351 928 484 451**.
